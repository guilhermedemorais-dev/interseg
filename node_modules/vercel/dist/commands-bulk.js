...
import {
  ...
  executeUpgrade,
  login
} from "./chunks/chunk-JM7YTFXQ.js";
import {
  getUpdateCommand,
  isGlobal
} from "./chunks/chunk-6BQDSUW6.js";
import {
  Now,
...
import {
  getScope
} from "./chunks/chunk-KDZYLR6U.js";
import {
  formatEnvironment,
  validateLsArgs
} from "./chunks/chunk-GTDGTWEY.js";
import {
  validateJsonOutput
...
import {
  ...
  listSubcommand11 as listSubcommand13,
  listSubcommand12 as listSubcommand14,
  listSubcommand13 as listSubcommand15,
  listSubcommand14 as listSubcommand16,
  listSubcommand2 as listSubcommand3,
  listSubcommand3 as listSubcommand4,
  listSubcommand4 as listSubcommand5,
  listSubcommand5 as listSubcommand6,
  listSubcommand6 as listSubcommand7,
  listSubcommand7 as listSubcommand8,
  listSubcommand8 as listSubcommand9,
  listSubcommand9 as listSubcommand10,
...
import {
  ...
  listSubcommand as listSubcommand12,
...
import {
  main
} from "./chunks/chunk-6NXY2OLP.js";
import "./chunks/chunk-ZER7BAFS.js";
import {
  require_dist as require_dist2,
  require_tar_fs
} from "./chunks/chunk-RQUG6O67.js";
import {
  require_lib as require_lib3
} from "./chunks/chunk-QXRJ52T4.js";
import {
  require_execa
} from "./chunks/chunk-3XOBMJP4.js";
import "./chunks/chunk-QLZZBARH.js";
import {
  ensureLink
} from "./chunks/chunk-5C6CQLVT.js";
import "./chunks/chunk-PZC4VEFN.js";
import "./chunks/chunk-ENFI7RR4.js";
import {
  VERCEL_CONFIG_EXTENSIONS
} from "./chunks/chunk-FFNOBWQ4.js";
import "./chunks/chunk-QVLCQV6Z.js";
import {
  help
...
async function activity(client) {
  ...
  switch (subcommand) {
    ...
    default: {
      ...
      const listFn = (await import("./chunks/list-Y2VR65SX.js")).default;
      return listFn(client, telemetry2);
    }
  }
}

// src/util/telemetry/commands/alerts/index.ts
var AlertsTelemetryClient = class extends TelemetryClient {
  trackCliSubcommandLs(v) {
    if (v) {
      this.trackCliSubcommand({
        subcommand: "ls",
...
async function alerts(client) {
  ...
  const { subcommandOriginal } = getSubcommand3(
    parsedArgs.args.slice(1),
    COMMAND_CONFIG2
  );
  const needHelp = parsedArgs.flags["--help"];
  ...
  telemetry2.trackCliSubcommandLs(subcommandOriginal);
  const listFn = (await import("./chunks/list-VF6TIK53.js")).default;
  return listFn(client, telemetry2);
}
...
async function api(client) {
  ...
  if (firstArg === "ls" || firstArg === "list") {
    const lsFlagsSpec = getFlagsSpecification(listSubcommand3.options);
    let lsParsedArgs;
    try {
...
async function bisect(client) {
  ...
  while (deployments.length > 0) {
    ...
    let action;
    if (run2) {
      const proc = await (0, import_execa.default)(run2, [testUrl], {
        stdio: "inherit",
        reject: false,
        env: {
          ...process.env,
...
async function list3(client, argv, rwToken) {
  ...
  const flagsSpecification = getFlagsSpecification(listSubcommand15.options);
  let parsedArgs;
  try {
...
function parseAccessFlag(accessFlag) {
  const access3 = accessFlag ?? "public";
  if (!isAccess(access3)) {
    output_manager_default.error(
      `Invalid access value: '${access3}'. Must be 'public' or 'private'.`
    );
    return null;
  }
  return access3;
...
var COMMAND_CONFIG5 = {
  list: getCommandAliases(listSubcommand15),
...
`
    ...
    client.stdin.on("data", (d) => {
      process.stdin.pause();
      resolve7(d.toString().trim().toLowerCase() === "y");
    }).resume();
  });
}
...
var CronsAddTelemetryClient = class extends TelemetryClient {
  ...
  trackCliOptionSchedule(schedule) {
    if (schedule) {
      this.trackCliOption({
        option: "schedule",
        value: this.redactedValue
...
async function add2(client, argv) {
  const telemetry2 = new CronsAddTelemetryClient({
    opts: {
      store: client.telemetryEventStore
    }
  });
  ...
  let cronPath = flags["--path"];
  let schedule = flags["--schedule"];
  telemetry2.trackCliOptionPath(cronPath);
  telemetry2.trackCliOptionSchedule(schedule);
  ...
  if (!cronPath.startsWith("/")) {
    output_manager_default.error("Path must start with /");
    return 1;
  }
  if (cronPath.length > 512) {
    output_manager_default.error("Path must be 512 characters or less");
    return 1;
  }
  const scheduleValidation = validateCronSchedule(schedule);
  if (scheduleValidation !== true) {
    output_manager_default.error(scheduleValidation);
    return 1;
  }
  for (const ext of VERCEL_CONFIG_EXTENSIONS) {
    const altPath = resolve5(client.cwd, `vercel.${ext}`);
    try {
      await access(altPath);
      output_manager_default.error(
        `Found ${import_chalk28.default.cyan(`vercel.${ext}`)} \u2014 ${getCommandName("crons add")} only supports ${import_chalk28.default.cyan("vercel.json")}. Add cron jobs directly to your ${import_chalk28.default.cyan(`vercel.${ext}`)} file instead.`
      );
      return 1;
    } catch {
    }
  ...
  try {
    ...
    if (err instanceof SyntaxError) {
      output_manager_default.error(
        `Failed to parse ${import_chalk28.default.cyan("vercel.json")}: ${err.message}`
      );
      return 1;
    }
    if (err instanceof Error && "code" in err && err.code === "ENOENT") {
      ...
      output_manager_default.error(
        `Failed to read ${import_chalk28.default.cyan("vercel.json")}: ${err instanceof Error ? err.message : String(err)}`
      );
      return 1;
    }
  }
  ...
  if (existingCrons.some((c) => c.path === cronPath)) {
    output_manager_default.error(
      `A cron job with path ${import_chalk28.default.bold(cronPath)} already exists in vercel.json`
    );
    return 1;
  }
  ...
  try {
    ...
    output_manager_default.error(
      `Failed to write ${import_chalk28.default.cyan("vercel.json")}: ${err instanceof Error ? err.message : String(err)}`
    );
    return 1;
  }
  output_manager_default.log(
    `Added cron job ${import_chalk28.default.bold(cronPath)} with schedule ${import_chalk28.default.bold(schedule)} to ${import_chalk28.default.cyan("vercel.json")}`
  );
  output_manager_default.warn(
...
async function ls3(client, argv) {
  const telemetry2 = new CronsLsTelemetryClient({
    opts: {
      store: client.telemetryEventStore
    }
  });
  ...
  const lsStamp = stamp_default();
  output_manager_default.spinner(
    `Fetching cron jobs for ${import_chalk29.default.bold(`${org.slug}/${project.name}`)}`
  );
  ...
  const isDisabled2 = projectData.crons?.disabledAt != null;
  const localConfig = readLocalConfig(client.cwd);
  const localCrons = Array.isArray(localConfig?.crons) ? localConfig.crons : [];
  const deployedByPath = new Map(definitions.map((d) => [d.path, d]));
  const undeployedCrons = [];
  const modifiedCrons = [];
...
`);
    ...
    output_manager_default.log(
      `No cron jobs found for ${import_chalk29.default.bold(`${org.slug}/${project.name}`)} ${import_chalk29.default.gray(lsStamp())}`
    );
  } else {
    const totalDeployed = definitions.length;
    if (totalDeployed > 0) {
      output_manager_default.log(
        `${totalDeployed} cron ${totalDeployed === 1 ? "job" : "jobs"} found for ${import_chalk29.default.bold(`${org.slug}/${project.name}`)}${isDisabled2 ? import_chalk29.default.yellow(" (disabled)") : ""} ${import_chalk29.default.gray(lsStamp())}`
      );
      output_manager_default.print(
...
function formatCronsTable(definitions) {
  const rows = definitions.map((cron) => [
    import_chalk29.default.bold(cron.path),
    cron.schedule
  ]);
...
function formatPendingCronsTable(undeployed, modified) {
  const rows = [
    ...modified.map(({ local, deployed }) => [
      import_chalk29.default.bold(local.path),
      `${import_chalk29.default.dim(deployed.schedule)} \u2192 ${local.schedule}`,
      import_chalk29.default.yellow("modified")
    ]),
    ...undeployed.map((cron) => [
      import_chalk29.default.dim(cron.path),
      import_chalk29.default.dim(cron.schedule),
      import_chalk29.default.yellow("not deployed")
    ])
  ];
  return formatTable(
...
async function run(client, argv) {
  const telemetry2 = new CronsRunTelemetryClient({
    opts: {
      store: client.telemetryEventStore
    }
  });
  ...
  if (definitions.length === 0) {
    output_manager_default.error(
      `No cron jobs found for ${import_chalk30.default.bold(`${org.slug}/${project.name}`)}. Define cron jobs in your vercel.json file.`
    );
    return 1;
  }
  if (projectData.crons?.disabledAt != null) {
    output_manager_default.error(
      `Cron jobs are disabled for ${import_chalk30.default.bold(`${org.slug}/${project.name}`)}. Enable them in the project settings.`
    );
    return 1;
  }
  if (!cronPath) {
    ...
    if (definitions.length === 1) {
      ...
      output_manager_default.log(`Auto-selected ${import_chalk30.default.bold(cronPath)} (only cron job)`);
    } else {
  ...
  if (!cronDef) {
    output_manager_default.error(
      `Cron job with path ${import_chalk30.default.bold(cronPath)} not found. Run ${getCommandName("crons ls")} to see available cron jobs.`
    );
    return 1;
  }
  output_manager_default.spinner(`Triggering cron job ${import_chalk30.default.bold(cronPath)}`);
  ...
  try {
    ...
    if (isAPIError(err)) {
      output_manager_default.error(
        `Failed to trigger cron job ${import_chalk30.default.bold(cronPath)}: ${err.message}`
      );
      return 1;
    }
    throw err;
  ...
  output_manager_default.log(
    `Cron job ${import_chalk30.default.bold(cronPath)} triggered ${import_chalk30.default.gray(runStamp())}`
  );
  output_manager_default.log(
    `  Invocation time: ${import_chalk30.default.cyan(new Date(result.invocationAt).toISOString())}`
  );
  return 0;
}

// src/util/telemetry/commands/crons/index.ts
var CronsTelemetryClient = class extends TelemetryClient {
  trackCliSubcommandAdd(actual) {
    this.trackCliSubcommand({
      subcommand: "add",
      value: actual
...
async function main6(client) {
  ...
  const telemetry2 = new CronsTelemetryClient({
    opts: {
      store: client.telemetryEventStore
    }
  });
  ...
  const needHelp = parsedArgs.flags["--help"];
  if (!subcommand && needHelp) {
    telemetry2.trackCliFlagHelp("crons");
    output_manager_default.print(help(cronsCommand, { columns: client.stderr.columns }));
    return 2;
  }
  function printHelp(command) {
    output_manager_default.print(
  ...
  switch (subcommand) {
    case "add":
      if (needHelp) {
        telemetry2.trackCliFlagHelp("crons", subcommandOriginal);
        return printHelp(addSubcommand2);
      }
      telemetry2.trackCliSubcommandAdd(subcommandOriginal);
    ...
    default:
      if (needHelp) {
        telemetry2.trackCliFlagHelp("crons", subcommandOriginal);
        return printHelp(listSubcommand5);
      }
      telemetry2.trackCliSubcommandList(subcommandOriginal);
...
async function createDeploymentProtectionToken(client, projectId, orgId) {
  ...
  try {
    ...
    output_manager_default.log(
      `Successfully generated deployment protection bypass token for project ${import_chalk31.default.bold(projectId)}
`
    );
    ...
    output_manager_default.log(`  1. Visit ${import_chalk31.default.cyan("https://vercel.com/dashboard")}`);
    ...
    output_manager_default.log(
      `  4. Use it with ${import_chalk31.default.cyan(
        "--protection-bypass"
      )} flag or set ${import_chalk31.default.cyan("VERCEL_AUTOMATION_BYPASS_SECRET")} env var`
    );
    output_manager_default.log("");
...
async function getDeploymentUrlAndToken(client, commandName, path3, options) {
  ...
  output_manager_default.debug(`${import_chalk32.default.cyan("Target URL:")} ${import_chalk32.default.bold(fullUrl)}`);
...
async function getDNSData(client, data) {
  ...
  try {
    ...
    if (type === "SRV") {
      ...
      output_manager_default.log(
        `${import_chalk33.default.cyan(name)} ${import_chalk33.default.bold(type)} ${import_chalk33.default.cyan(
          `${priority}`
        )} ${import_chalk33.default.cyan(`${weight}`)} ${import_chalk33.default.cyan(`${port}`)} ${import_chalk33.default.cyan(
          target
        )}.`
      );
    ...
    if (type === "MX") {
      ...
      output_manager_default.log(
        `${import_chalk33.default.cyan(name)} ${import_chalk33.default.bold(type)} ${import_chalk33.default.cyan(
          `${mxPriority}`
        )} ${import_chalk33.default.cyan(value2)}`
      );
      return await verifyData(client) ? {
        name,
        type,
    ...
    output_manager_default.log(`${import_chalk33.default.cyan(name)} ${import_chalk33.default.bold(type)} ${import_chalk33.default.cyan(value)}`);
    return await verifyData(client) ? {
      name,
      type,
      value
...
async function add3(client, argv) {
  ...
  if (record instanceof DomainNotFound) {
    output_manager_default.error(
      `The domain ${domain2} can't be found under ${import_chalk34.default.bold(
        contextName
      )} ${import_chalk34.default.gray(addStamp())}`
    );
    return 1;
  }
  ...
  output_manager_default.success(
    `DNS record for domain ${import_chalk34.default.bold(domain2)} ${import_chalk34.default.gray(
      `(${record.uid})`
    )} created under ${import_chalk34.default.bold(contextName)} ${import_chalk34.default.gray(addStamp())}`
  );
  return 0;
}
...
async function importZonefile(client, contextName, domain2, zonefilePath) {
  output_manager_default.spinner(
    `Importing Zone file for domain ${domain2} under ${import_chalk35.default.bold(contextName)}`
  );
...
async function importZone(client, argv) {
  ...
  output_manager_default.success(
    `${recordIds.length} DNS records for domain ${import_chalk36.default.bold(
      domain2
...
async function getDomainNames(client, contextName, next) {
  output_manager_default.spinner(`Fetching domains under ${import_chalk37.default.bold(contextName)}`);
...
async function ls4(client, argv) {
  ...
  if (domainName) {
    ...
    output_manager_default.log(
      `${records.length > 0 ? "Records" : "No records"} found under ${import_chalk38.default.bold(contextName)} ${import_chalk38.default.gray(lsStamp())}`
    );
  ...
  output_manager_default.log(
    `${nRecords > 0 ? "Records" : "No records"} found under ${import_chalk38.default.bold(
      contextName
    )} ${import_chalk38.default.gray(lsStamp())}`
  );
...
function getDNSRecordsTable(dnsRecords) {
  return formatTable(
    ...
    dnsRecords.map(({ domainName, records }) => ({
      name: import_chalk38.default.bold(domainName),
...
function getDNSRecordRow(record) {
  ...
  return [
    ...
    import_chalk38.default.gray(isSystemRecord ? "default" : createdAt)
  ];
}
...
async function rm3(client, argv) {
  ...
  output_manager_default.success(
    `Record ${import_chalk39.default.gray(`${record.id}`)} removed ${import_chalk39.default.gray(rmStamp())}`
  );
  return 0;
}
...
`
    ...
    output_manager_default.print(
      `${import_chalk39.default.bold.red("> Are you sure?")} ${import_chalk39.default.gray("(y/N) ")}`
    );
    client.stdin.on("data", (d) => {
      process.stdin.pause();
      resolve7(d.toString().trim().toLowerCase() === "y");
...
function getDeleteTableRow(domainName, record) {
  ...
  return [
    record.id,
    import_chalk39.default.bold(
      `${recordName} ${record.type} ${record.value} ${record.mxPriority || ""}`
    ),
    import_chalk39.default.gray(
...
var COMMAND_CONFIG10 = {
  add: getCommandAliases(addSubcommand3),
...
function formatNSTable(intendedNameservers, currentNameservers, { extraSpace = "" } = {}) {
  ...
  for (let i = 0; i < maxLength; i++) {
    rows.push([
      sortedIntended[i] || import_chalk40.default.gray("-"),
      sortedCurrent[i] || import_chalk40.default.gray("-"),
      sortedIntended[i] === sortedCurrent[i] ? import_chalk40.default.green(chars_default.tick) : import_chalk40.default.red(chars_default.cross)
    ]);
  }
  return table(
    [
      [
        import_chalk40.default.gray("Intended Nameservers"),
        import_chalk40.default.gray("Current Nameservers"),
        ""
      ],
      ...rows
    ],
...
async function addDomainToProject(client, projectNameOrId, domain2) {
  output_manager_default.spinner(
    `Adding domain ${domain2} to project ${import_chalk41.default.bold(projectNameOrId)}`
  );
  try {
    const response = await client.fetch(
...
async function removeDomainFromProject(client, projectNameOrId, domain2) {
  output_manager_default.spinner(
    `Removing domain ${domain2} from project ${import_chalk42.default.bold(projectNameOrId)}`
  );
  try {
    const response = await client.fetch(
...
async function add4(client, argv) {
  ...
  output_manager_default.success(
    `Domain ${import_chalk43.default.bold(domainName)} added to project ${import_chalk43.default.bold(
      projectName
    )}. ${addStamp()}`
  );
  ...
  if (domainConfig.misconfigured) {
    ...
    output_manager_default.print(
      `  ${import_chalk43.default.grey("a)")} Set the following record on your DNS provider to continue: ${code(`A ${domainName} 76.76.21.21`)} ${import_chalk43.default.grey("[recommended]")}
`
    );
    output_manager_default.print(
      `  ${import_chalk43.default.grey("b)")} Change your Domains's nameservers to the intended set`
    );
    output_manager_default.print(
      `
${formatNSTable(
...
async function transferIn(client, argv) {
  ...
  const { contextName } = await getScope(client);
  output_manager_default.log(
    `The domain ${param(domainName)} is ${import_chalk44.default.underline(
      "available"
    )} to transfer under ${import_chalk44.default.bold(contextName)}! ${availableStamp()}`
  );
  const authCode = await getAuthCode(client, opts["--code"]);
  const shouldTransfer = await client.input.confirm(
    `Transfer now with 1yr renewal for ${import_chalk44.default.bold(`$${transferPrice}`)}?`,
    false
  );
  if (!shouldTransfer) {
    return 0;
...
async function inspect(client, argv) {
  ...
  if (args.length !== 1) {
    output_manager_default.error(
      `Invalid number of arguments. Usage: ${import_chalk45.default.cyan(
  ...
  const { contextName } = await getScope(client);
  output_manager_default.spinner(
    `Fetching Domain ${domainName} under ${import_chalk45.default.bold(contextName)}`
  );
  ...
  output_manager_default.log(
    `Domain ${domainName} found under ${import_chalk45.default.bold(contextName)} ${import_chalk45.default.gray(
      inspectStamp()
    )}`
  );
  output_manager_default.print("\n");
  output_manager_default.print(import_chalk45.default.bold("  General\n\n"));
  output_manager_default.print(`    ${import_chalk45.default.cyan("Name")}			${domain2.name}
`);
  output_manager_default.print(
    `    ${import_chalk45.default.cyan("Registrar")}			${getDomainRegistrar(domain2)}
`
  );
  output_manager_default.print(
    `    ${import_chalk45.default.cyan("Expiration Date")}		${formatDate(domain2.expiresAt)}
`
  );
  output_manager_default.print(
    `    ${import_chalk45.default.cyan("Creator")}			${domain2.creator.username}
`
  );
  output_manager_default.print(
    `    ${import_chalk45.default.cyan("Created At")}			${formatDate(domain2.createdAt)}
`
  );
  output_manager_default.print(`    ${import_chalk45.default.cyan("Edge Network")}		yes
`);
  output_manager_default.print(
    `    ${import_chalk45.default.cyan("Renewal Price")}		${domain2.boughtAt && renewalPrice ? `$${renewalPrice} USD` : import_chalk45.default.gray("-")}
`
  );
  output_manager_default.print("\n");
  output_manager_default.print(import_chalk45.default.bold("  Nameservers\n\n"));
  output_manager_default.print(
...
`
  ...
  if (Array.isArray(projects) && projects.length > 0) {
    output_manager_default.print(import_chalk45.default.bold("  Projects\n"));
...
`
    ...
    output_manager_default.print(
      `  ${import_chalk45.default.grey("b)")} Change your Domains's nameservers to the intended set detailed above.
...
`);
    ...
    output_manager_default.log(
      `${(0, import_pluralize5.default)("Domain", domains2.length, true)} found under ${import_chalk46.default.bold(
        contextName
...
function formatDomainsTable(domains2) {
  ...
  const rows = domains2.map((domain2) => {
    ...
    return [
      ...
      import_chalk46.default.gray(age)
    ];
  });
  return formatTable(
...
async function rm4(client, argv) {
  ...
  if (domain2 instanceof DomainNotFound || domain2.name !== domainName) {
    output_manager_default.error(
      `Domain not found by "${domainName}" under ${import_chalk47.default.bold(contextName)}`
    );
    output_manager_default.log(`Run ${getCommandName(`domains ls`)} to see your domains.`);
    return 1;
  }
  if (domain2 instanceof DomainPermissionDenied) {
    output_manager_default.error(
      `You don't have access to the domain ${domainName} under ${import_chalk47.default.bold(
        contextName
      )}`
    );
    output_manager_default.log(`Run ${getCommandName(`domains ls`)} to see your domains.`);
...
async function removeDomain(client, contextName, skipConfirmation, domain2, aliasIds = [], certIds = [], suffix = false, attempt = 1) {
  ...
  if (removeResult instanceof DomainNotFound) {
    output_manager_default.error(`Domain not found under ${import_chalk47.default.bold(contextName)}`);
    output_manager_default.log(`Run ${getCommandName(`domains ls`)} to see your domains.`);
    return 1;
  }
  if (removeResult instanceof DomainPermissionDenied) {
    output_manager_default.error(
      `You don't have permissions over domain ${import_chalk47.default.underline(
        removeResult.meta.domain
      )} under ${import_chalk47.default.bold(removeResult.meta.context)}.`
    );
    return 1;
  }
  if (removeResult instanceof DomainRemovalConflict) {
    ...
    if (aliases.length > 0) {
      output_manager_default.warn(
        `This domain's ${import_chalk47.default.bold(
    ...
    if (suffix2) {
      output_manager_default.warn(
        `The ${import_chalk47.default.bold(`custom suffix`)} associated with this domain.`
      );
    }
    if (!skipConfirmation && !await client.input.confirm(
  ...
  output_manager_default.success(`Domain ${import_chalk47.default.bold(domain2.name)} removed ${removeStamp()}`);
  return 0;
}
...
async function move(client, argv) {
  ...
  if (domain2 instanceof DomainPermissionDenied) {
    output_manager_default.error(
      `You don't have permissions over domain ${import_chalk48.default.underline(
        domain2.meta.domain
      )} under ${import_chalk48.default.bold(domain2.meta.context)}.`
    );
    return 1;
  }
  ...
  if (moveTokenResult instanceof DomainPermissionDenied) {
    output_manager_default.error(
      ...
      )} under ${import_chalk48.default.bold(moveTokenResult.meta.context)}.`
    );
    return 1;
  }
  if (moveTokenResult instanceof InvalidMoveDestination) {
    output_manager_default.error(
      `Destination ${import_chalk48.default.bold(
        destination
  ...
  switch (subcommand) {
    case "add":
      if (needHelp) {
        ...
        return printHelp(addSubcommand4);
      }
      telemetry2.trackCliSubcommandAdd(subcommandOriginal);
...
async function ls6(client, argv) {
  ...
  try {
    ...
    if (json) {
      ...
      output_manager_default.log(
        `No ${state} feature flags found for ${projectSlugLink} ${import_chalk49.default.gray(lsStamp())}`
      );
    } else {
      output_manager_default.log(
        `${(0, import_pluralize8.default)("feature flag", flagsList.length, true)} found for ${projectSlugLink} ${import_chalk49.default.gray(lsStamp())}`
      );
...
function printFlagsTable(flags) {
  ...
  const rows = flags.map((flag) => [
    import_chalk49.default.bold(flag.slug),
    flag.kind,
    flag.state === "active" ? import_chalk49.default.green(flag.state) : import_chalk49.default.gray(flag.state),
...
function formatCondition2(condition, settings) {
  ...
  const cmp = import_chalk50.default.dim(formatComparison(condition.cmp));
    ...
    if (condition.rhs.type === "list" && Array.isArray(condition.rhs.items)) {
      const items = condition.rhs.items.map((item) => {
        ...
        if (condition.lhs.type === "entity") {
          ...
          return label ? `${itemValue} ${import_chalk50.default.gray(label)}` : itemValue;
        }
        return itemValue;
      });
  ...
  if (condition.lhs.type === "entity") {
    ...
    rhs = label ? `${condition.rhs} ${import_chalk50.default.gray(label)}` : String(condition.rhs);
  } else {
...
function printFlagDetails(flag, settings, projectSlugLink, orgSlug, projectName) {
  ...
  output_manager_default.log(
    `
Feature flag ${import_chalk50.default.bold(flag.slug)} for ${projectSlugLink}
`
  );
  output_manager_default.print(`  ${import_chalk50.default.cyan(dashboardUrl)}

`);
  output_manager_default.print(`  ${import_chalk50.default.dim("ID:")}           ${flag.id}
`);
  output_manager_default.print(`  ${import_chalk50.default.dim("Kind:")}         ${flag.kind}
`);
  output_manager_default.print(
    `  ${import_chalk50.default.dim("State:")}        ${flag.state === "active" ? import_chalk50.default.green(flag.state) : import_chalk50.default.gray(flag.state)}
`
  );
  if (flag.description) {
    output_manager_default.print(`  ${import_chalk50.default.dim("Description:")}  ${flag.description}
`);
  }
  output_manager_default.print(
    `  ${import_chalk50.default.dim("Created:")}      ${formatDate(flag.createdAt)}
`
  );
  output_manager_default.print(
    `  ${import_chalk50.default.dim("Updated:")}      ${formatDate(flag.updatedAt)}
`
  );
  output_manager_default.print(`
  ${import_chalk50.default.dim("Variants:")}
`);
  for (const variant of flag.variants) {
    output_manager_default.print(`    ${import_chalk50.default.cyan(variant.id)}
`);
    if (variant.label) {
      output_manager_default.print(`      ${import_chalk50.default.dim("Label:")} ${variant.label}
`);
    }
    output_manager_default.print(
      `      ${import_chalk50.default.dim("Value:")} ${import_chalk50.default.yellow(JSON.stringify(variant.value))}
`
    );
  }
  ...
  output_manager_default.print(`
  ${import_chalk50.default.dim("Environments:")}
`);
  for (const [envName, envConfig] of sortedEnvs) {
    if (envConfig.active) {
      if (envConfig.reuse?.active) {
        output_manager_default.print(
          `    ${import_chalk50.default.bold(envName)}: reuses ${import_chalk50.default.cyan(envConfig.reuse.environment)} environment
`
        );
        continue;
      }
      output_manager_default.print(`    ${import_chalk50.default.bold(envName)}: ${import_chalk50.default.green("active")}
`);
      if (envConfig.targets && Object.keys(envConfig.targets).length > 0) {
        output_manager_default.print(`      ${import_chalk50.default.dim("Targeting:")}
`);
          ...
          for (const [entityKind, attributes] of Object.entries(entityKinds)) {
            for (const [attribute, values] of Object.entries(attributes)) {
              const valueList = values.map((v) => {
                ...
                return label ? `${v.value} ${import_chalk50.default.gray(label)}` : v.value;
              }).join(", ");
              output_manager_default.print(
                `        ${import_chalk50.default.dim(`${entityKind}.${attribute}:`)} ${valueList} ${import_chalk50.default.dim("\u2192")} ${variantLabel}
`
              );
            }
          }
      ...
      if (envConfig.rules && envConfig.rules.length > 0) {
        output_manager_default.print(`      ${import_chalk50.default.dim("Rules:")}
`);
        for (const rule of envConfig.rules) {
          const outcome = formatRuleOutcome(rule.outcome, flag.variants);
          output_manager_default.print(`        ${import_chalk50.default.dim("\u2192")} ${outcome}
`);
          for (const condition of rule.conditions) {
            const { text, listItems } = formatCondition2(condition, settings);
            output_manager_default.print(`          ${import_chalk50.default.dim("if")} ${text}
`);
            if (listItems && listItems.length > 0) {
              for (const item of listItems) {
                output_manager_default.print(`             ${import_chalk50.default.dim("-")} ${item}
`);
              }
            }
          }
      ...
      if (envConfig.fallthrough) {
        ...
        if (fallthrough.type === "variant") {
          ...
          output_manager_default.print(`      ${import_chalk50.default.dim("Default:")} ${defaultLabel}
`);
          ...
          output_manager_default.print(`      ${import_chalk50.default.dim("Default split:")} ${weights}
`);
        }
      }
    } else {
      output_manager_default.print(`    ${import_chalk50.default.bold(envName)}: ${import_chalk50.default.yellow("paused")}
`);
    }
  }
  output_manager_default.print("\n");
...
async function add5(client, argv) {
  ...
  try {
    ...
    output_manager_default.stopSpinner();
    output_manager_default.success(
      `Feature flag ${import_chalk51.default.bold(flag.slug)} created successfully`
    );
    output_manager_default.log(`
  ${import_chalk51.default.dim("ID:")}    ${flag.id}`);
    output_manager_default.log(`  ${import_chalk51.default.dim("Kind:")}  ${flag.kind}`);
    output_manager_default.log(`  ${import_chalk51.default.dim("Slug:")}  ${flag.slug}
`);
    output_manager_default.log(
      `View in dashboard: ${import_chalk51.default.cyan(getFlagDashboardUrl(link.org.slug, project.name, flag.slug))}`
    );
  } catch (err) {
    output_manager_default.stopSpinner();
    printError(err);
...
async function rm5(client, argv) {
  ...
  try {
    ...
    if (flag.state !== "archived") {
      output_manager_default.error(
        `Flag ${import_chalk52.default.bold(flag.slug)} must be archived before it can be deleted. Run ${getCommandName(`flags archive ${flag.slug}`)} first.`
      );
      return 1;
    }
    if (!skipConfirmation) {
      const confirmed = await client.input.confirm(
        `Are you sure you want to delete ${import_chalk52.default.bold(flag.slug)}? This action cannot be undone.`,
        false
      );
      if (!confirmed) {
    ...
    output_manager_default.stopSpinner();
    output_manager_default.success(`Feature flag ${import_chalk52.default.bold(flag.slug)} has been deleted`);
  } catch (err) {
    output_manager_default.stopSpinner();
    printError(err);
    return 1;
...
async function archive(client, argv) {
  ...
  try {
    ...
    output_manager_default.stopSpinner();
    if (flag.state === "archived") {
      output_manager_default.warn(`Flag ${import_chalk53.default.bold(flag.slug)} is already archived`);
      return 0;
    }
    if (!skipConfirmation) {
      const confirmed = await client.input.confirm(
        `Are you sure you want to archive ${import_chalk53.default.bold(flag.slug)}?`,
        false
      );
      if (!confirmed) {
        output_manager_default.log("Aborted");
    ...
    output_manager_default.stopSpinner();
    output_manager_default.success(`Feature flag ${import_chalk53.default.bold(flag.slug)} has been archived`);
    output_manager_default.log(
      `
To restore this flag, visit the dashboard: ${import_chalk53.default.cyan(getFlagsDashboardUrl(link.org.slug, project.name) + "/archive")}`
    );
  } catch (err) {
    output_manager_default.stopSpinner();
    printError(err);
...
async function disable(client, argv) {
  ...
  try {
    ...
    if (flag.state === "archived") {
      output_manager_default.error(
        `Flag ${import_chalk54.default.bold(flag.slug)} is archived and cannot be disabled`
      );
      return 1;
    }
    if (flag.kind !== "boolean") {
      ...
      output_manager_default.log(
        `Flag ${import_chalk54.default.bold(flag.slug)} is a ${import_chalk54.default.cyan(flag.kind)} flag. You can update it on the dashboard:`
      );
      output_manager_default.log(`  ${import_chalk54.default.cyan(dashboardUrl)}`);
      return 0;
    }
    if (!environment) {
      ...
      environment = await client.input.select({
        ...
        choices: availableEnvs.map((env) => {
          ...
          const status3 = config?.active ? import_chalk54.default.green("active") : import_chalk54.default.yellow("paused");
          return {
            name: `${env} (${status3})`,
            value: env
          };
    ...
    if (!envConfig.active) {
      output_manager_default.warn(
        `Flag ${import_chalk54.default.bold(flag.slug)} is already disabled in ${environment}`
      );
      return 0;
    }
    ...
    if (selectedVariantId) {
      ...
      selectedVariantId = await client.input.select({
        ...
        choices: flag.variants.map((v) => ({
          name: `${v.id} (${import_chalk54.default.yellow(JSON.stringify(v.value))})${v.label ? ` - ${v.label}` : ""}`,
          value: v.id
        }))
      });
    }
    ...
    output_manager_default.success(
      `Feature flag ${import_chalk54.default.bold(flag.slug)} has been disabled in ${import_chalk54.default.bold(environment)}`
    );
    output_manager_default.log(
      `  ${import_chalk54.default.dim("Serving variant:")} ${selectedVariantId} (${import_chalk54.default.yellow(variantValue)})`
    );
  } catch (err) {
    output_manager_default.stopSpinner();
    printError(err);
...
async function enable(client, argv) {
  ...
  try {
    ...
    if (flag.state === "archived") {
      output_manager_default.error(
        `Flag ${import_chalk55.default.bold(flag.slug)} is archived and cannot be enabled`
      );
      return 1;
    }
    if (flag.kind !== "boolean") {
      ...
      output_manager_default.log(
        `Flag ${import_chalk55.default.bold(flag.slug)} is a ${import_chalk55.default.cyan(flag.kind)} flag. You can update it on the dashboard:`
      );
      output_manager_default.log(`  ${import_chalk55.default.cyan(dashboardUrl)}`);
      return 0;
    }
    if (!environment) {
      const availableEnvs = Object.keys(flag.environments).filter(
      ...
      environment = await client.input.select({
        ...
        choices: availableEnvs.map((env) => {
          const config = flag.environments[env];
          const status3 = config?.active ? import_chalk55.default.green("active") : import_chalk55.default.yellow("paused");
          return {
            name: `${env} (${status3})`,
            value: env
          };
    ...
    if (envConfig.active) {
      output_manager_default.warn(
        `Flag ${import_chalk55.default.bold(flag.slug)} is already enabled in ${environment}`
      );
      return 0;
    }
    const updatedEnvConfig = {
    ...
    output_manager_default.stopSpinner();
    output_manager_default.success(
      `Feature flag ${import_chalk55.default.bold(flag.slug)} has been enabled in ${import_chalk55.default.bold(environment)}`
    );
    output_manager_default.log(
      `  ${import_chalk55.default.dim("The flag will now evaluate rules and serve variants based on its configuration.")}`
    );
  } catch (err) {
    output_manager_default.stopSpinner();
    printError(err);
...
Create one with: ${getCommandName("flags sdk-keys add --type server --environment production")}`
      ...
      output_manager_default.log(
        `${import_chalk56.default.bold(keys.length)} SDK key${keys.length === 1 ? "" : "s"} found for ${projectSlugLink}`
      );
...
function printSdkKeysTable(keys) {
  ...
  const rows = keys.map((key) => [
    import_chalk56.default.dim(key.hashKey.slice(0, 12) + "..."),
    getTypeLabel(key.type),
    key.environment,
    key.label || import_chalk56.default.dim("-"),
...
function getTypeLabel(type) {
  switch (type) {
    case "server":
      return import_chalk56.default.blue("server");
    case "client":
      return import_chalk56.default.green("client");
    case "mobile":
      return import_chalk56.default.yellow("mobile");
    default:
      return type;
  }
}
...
async function sdkKeysAdd(client, argv) {
  ...
  try {
    ...
    output_manager_default.print("\n");
    output_manager_default.print(`  ${import_chalk57.default.dim("Hash Key:")}     ${key.hashKey}
`);
    output_manager_default.print(`  ${import_chalk57.default.dim("Type:")}         ${key.type}
`);
    output_manager_default.print(`  ${import_chalk57.default.dim("Environment:")}  ${key.environment}
`);
    if (key.label) {
      output_manager_default.print(`  ${import_chalk57.default.dim("Label:")}        ${key.label}
`);
    }
    if (key.keyValue) {
      output_manager_default.print("\n");
      ...
      output_manager_default.print(`
  ${import_chalk57.default.cyan(key.keyValue)}
`);
    }
    if (key.connectionString) {
      output_manager_default.print("\n");
      output_manager_default.log(`${import_chalk57.default.dim("Connection string:")}`);
      output_manager_default.print(`  ${import_chalk57.default.cyan(key.connectionString)}
`);
    }
  } catch (err) {
    output_manager_default.stopSpinner();
...
async function sdkKeysRm(client, argv) {
  ...
  try {
    ...
    if (!skipConfirmation) {
      const confirmed = await client.input.confirm(
        `Are you sure you want to delete SDK key ${import_chalk58.default.bold(hashKey.slice(0, 12) + "...")}?`,
        false
      );
      if (!confirmed) {
        output_manager_default.log("Aborted");
    ...
    output_manager_default.stopSpinner();
    output_manager_default.success(
      `SDK key ${import_chalk58.default.bold(hashKey.slice(0, 12) + "...")} has been deleted`
    );
  } catch (err) {
    output_manager_default.stopSpinner();
    printError(err);
...
async function connect(client, argv) {
  ...
  if (args.length > 1) {
    output_manager_default.error(
      `Invalid number of arguments. Usage: ${import_chalk59.default.cyan(
  ...
  if (!gitConfig) {
    output_manager_default.error(
      `No local Git repository found. Run ${import_chalk59.default.cyan(
        "`git clone <url>`"
  ...
  if (!remoteUrls) {
    output_manager_default.error(
      `No remote URLs found in your Git config. Make sure you've configured a remote repo in your local Git config. Run ${import_chalk59.default.cyan(
        "`git remote --help`"
      )} for more details.`
    );
    return 1;
...
async function promptConnectArg({
  ...
  if (Object.keys(remoteUrls).length > 1) {
    ...
    output_manager_default.log(
      `Found a repository in your local Git Config: ${import_chalk59.default.cyan(
...
`
    ...
    const confirmDisconnect = autoConfirm || await client.input.confirm(
      `Are you sure you want to disconnect ${import_chalk60.default.cyan(
        `${linkOrg}/${repo}`
      )} from your project?`,
      false
    );
    if (confirmDisconnect) {
      ...
      output_manager_default.log(`Disconnected ${import_chalk60.default.cyan(`${linkOrg}/${repo}`)}.`);
    } else {
      output_manager_default.log("Canceled");
    }
  } else {
...
async function status(client) {
  ...
  const status3 = enabled ? import_chalk61.default.green("Enabled") : import_chalk61.default.red("Disabled");
  output_manager_default.print("\n");
  output_manager_default.log(`${import_chalk61.default.bold("Guidance status")}: ${status3}`);
  output_manager_default.print("\n");
  return 0;
}
...
async function extractExample(client, name, dir, force, ver = "v2") {
  ...
  return client.fetch(url, { json: false }).then(async (res) => {
    ...
    const successLog = `Initialized "${import_chalk62.default.bold(
      name
    )}" example in ${import_chalk62.default.bold(humanizePath(folder))}.`;
...
function prepareFolder(cwd, folder, force) {
  ...
  if (fs.existsSync(dest)) {
    if (!fs.lstatSync(dest).isDirectory()) {
      throw new Error(
        `Destination path "${import_chalk62.default.bold(
          folder
    ...
    try {
      ...
      throw new Error(`Could not create directory "${import_chalk62.default.bold(folder)}".`);
    }
  }
  return dest;
}
async function guess(client, exampleList, name) {
  const GuessError = new Error(
    `No example found for ${import_chalk62.default.bold(name)}, run ${getCommandName(
      "init"
  ...
  if (typeof found === "string") {
    if (await client.input.confirm(`Did you mean ${import_chalk62.default.bold(found)}?`, false)) {
      return found;
    }
  } else {
    throw GuessError;
...
async function main10(client) {
  ...
  const args = getSubcommand3(parsedArgs.args.slice(1), COMMAND_CONFIG16).args;
...
var styleBuild = (build, times, longestSource) => {
  ...
  let pathColor = import_chalk63.default.cyan;
  if (isFailed(build)) {
    pathColor = import_chalk63.default.red;
  }
  const entry = entrypoint.padEnd(longestSource + padding);
  const prefix = hasOutput(build) ? "\u250C" : "\u2576";
  return `${import_chalk63.default.grey(prefix)} ${pathColor(entry)}${time}`;
};
var styleHiddenBuilds = (commonPath, buildGroup, times, longestSource, isHidden2 = false) => {
  ...
  if (isHidden2) {
    pathColor = import_chalk63.default.grey;
  }
  return `${import_chalk63.default.grey(prefix)} ${pathColor(entry)}${time}`;
};
var styleOutput = (output, readyState, isLast) => {
  ...
  const finalSize = size ? ` ${import_chalk63.default.grey(`(${(0, import_bytes3.default)(size)})`)}` : "";
  let color = import_chalk63.default.grey;
  let finalRegion = "";
  if (isReady({ readyState })) {
    color = import_chalk63.default;
  } else if (isFailed({ readyState })) {
    color = import_chalk63.default.red;
  }
  if (lambda) {
    const { deployedTo } = lambda;
    if (deployedTo && deployedTo.length > 0) {
      finalRegion = ` ${import_chalk63.default.grey(`[${deployedTo.join(", ")}]`)}`;
    }
  }
  const corner = isLast ? "\u2514\u2500\u2500" : "\u251C\u2500\u2500";
  const main20 = prefix + path3 + finalSize + finalRegion;
  return `${import_chalk63.default.grey(corner)} ${color(main20)}`;
};
...
function routes(routes2) {
  ...
  const arrow = import_chalk64.default.grey("->");
  for (const item of routes2) {
    if ("handle" in item) {
      toPrint += `${import_chalk64.default.grey("\u2576")} ${import_chalk64.default.cyan(item.handle)}`;
      continue;
    }
    ...
    const suffix = last ? "" : `
`;
    const finalSrc = import_chalk64.default.cyan(src.padEnd(longestSrc + padding2));
    const finalDest = dest ? `${arrow}${space}${dest}` : `  ${space}${destSpace}`;
    const finalStatus = status3 ? import_chalk64.default.grey(`[${status3}]`) : "";
...
`;
      ...
      for (const header of headerKeys) {
        ...
        const suffix2 = last2 ? "" : `
`;
        const prefix2 = import_chalk64.default.grey(last2 ? "\u2514\u2500\u2500" : "\u251C\u2500\u2500");
        finalHeaders += `${prefix2} ${header}: ${value}${suffix2}`;
      }
    }
    const prefix = import_chalk64.default.grey(finalHeaders ? "\u250C" : "\u2576");
...
async function inspect3(client) {
  ...
  output_manager_default.spinner(
    `Fetching deployment "${deploymentIdOrHost}" in ${import_chalk65.default.bold(contextName)}`
  );
  ...
  if (asJson) {
    ...
    print(`${import_chalk65.default.cyan("status")}	${stateString(deployment.readyState)}
`);
  } else {
...
function stateString(s) {
  ...
  switch (s) {
    case "INITIALIZING":
    case "BUILDING":
      return import_chalk65.default.yellow(CIRCLE) + sTitle;
    case "ERROR":
      return import_chalk65.default.red(CIRCLE) + sTitle;
    case "READY":
      return import_chalk65.default.green(CIRCLE) + sTitle;
    case "QUEUED":
      return import_chalk65.default.gray(CIRCLE) + sTitle;
    case "CANCELED":
      return import_chalk65.default.gray(CIRCLE) + sTitle;
    default:
      return import_chalk65.default.gray("UNKNOWN");
  }
}
async function printDetails({
  ...
  output_manager_default.log(
    `Fetched deployment "${import_chalk65.default.bold(deployment.url)}" in ${import_chalk65.default.bold(
      contextName
  ...
  print("\n");
  print(import_chalk65.default.bold("  General\n\n"));
  print(`    ${import_chalk65.default.cyan("id")}		${id}
`);
  print(`    ${import_chalk65.default.cyan("name")}	${name}
`);
  ...
  print(`    ${import_chalk65.default.cyan("target")}	`);
  print(
...
`
  ...
  print(`    ${import_chalk65.default.cyan("status")}	${stateString(readyState)}
`);
  print(`    ${import_chalk65.default.cyan("url")}		https://${url}
`);
  if (createdAt) {
    print(
      `    ${import_chalk65.default.cyan("created")}	${new Date(createdAt)} ${elapsed(
        Date.now() - createdAt,
        true
      )}
`
  ...
  if (aliases !== void 0 && aliases.length > 0) {
    print(import_chalk65.default.bold("  Aliases\n\n"));
    let aliasList = "";
    for (const alias2 of aliases) {
      aliasList += `${import_chalk65.default.gray("\u2576")} https://${alias2}
`;
    }
...
async function postProvisionSetup(client, resourceName, resourceId, contextName, options = {}) {
  ...
  output_manager_default.spinner(
    `Connecting ${import_chalk66.default.bold(resourceName)} to ${import_chalk66.default.bold(project.name)}...`
  );
  ...
  output_manager_default.stopSpinner();
  output_manager_default.log(
    `${import_chalk66.default.bold(resourceName)} successfully connected to ${import_chalk66.default.bold(project.name)}`
  );
...
function formatMetadataSchemaHelp(schema, integrationName, productSlug) {
  ...
  lines.push(import_chalk67.default.bold(header));
  lines.push("");
  ...
  for (const [key, prop] of entries) {
    ...
    const requiredSuffix = isRequired && !isServerHandledRegion(prop) ? import_chalk67.default.red(" (required)") : "";
    const typeHint = prop.type === "boolean" ? import_chalk67.default.dim(" (true/false)") : prop.type === "array" ? import_chalk67.default.dim(" (comma-separated)") : "";
    lines.push(`    ${import_chalk67.default.cyan(key)}${requiredSuffix}${typeHint}`);
    if (prop.description) {
    ...
    if (example) {
      lines.push(`      Example: ${import_chalk67.default.dim(example)}`);
    }
    lines.push("");
  }
  return lines.join("\n");
...
Example: vercel ${commandName} ${integrationSlug}/${integration.products[0].slug}`
  ...
  output_manager_default.log(
    `Installing ${import_chalk68.default.bold(product.name)} by ${import_chalk68.default.bold(integration.name)} under ${import_chalk68.default.bold(contextName)}`
  );
...
Re-run with --installation-id to select one, e.g.:
  ...
  output_manager_default.success(
    `${product.name} successfully provisioned: ${import_chalk68.default.bold(resourceName)}`
  );
  ...
  output_manager_default.log(
    indent_default(
      `Guide: Run ${import_chalk68.default.cyan(`\`${guideCommand}\``)} for getting started guides and code snippets`,
      4
    )
  );
...
// src/commands/integration/add.ts
async function add6(client, args, flags, commandName) {
  ...
  output_manager_default.log(
    `Installing ${import_chalk69.default.bold(product.name)} by ${import_chalk69.default.bold(integration.name)} under ${import_chalk69.default.bold(contextName)}`
  );
...
async function confirmProductSelection(client, product, name, metadata, billingPlan) {
  ...
  output_manager_default.print(`${import_chalk69.default.dim(`- ${import_chalk69.default.bold("Name:")} ${name}`)}
`);
  for (const [key, value] of Object.entries(metadata)) {
    output_manager_default.print(
      `${import_chalk69.default.dim(`- ${import_chalk69.default.bold(`${product.metadataSchema.properties[key]["ui:label"]}:`)} ${value}`)}
`
    );
  }
  output_manager_default.print(
    `${import_chalk69.default.dim(`- ${import_chalk69.default.bold("Plan:")} ${billingPlan.name}`)}
`
  );
...
async function provisionStorageProduct(client, product, installation, name, metadata, billingPlan, authorizationId, integrationSlug, contextName, options = {}) {
  ...
  output_manager_default.success(
    `${product.name} successfully provisioned: ${import_chalk69.default.bold(name)}`
  );
...
function formatProductHelp(integrationSlug, products, commandName = "integration add") {
  ...
  lines.push("");
  lines.push(
    `  ${import_chalk70.default.dim("Available products for")} "${import_chalk70.default.bold(integrationSlug)}"${import_chalk70.default.dim(":")}`
  );
  lines.push("");
  const maxSlugLen = Math.max(...products.map((p) => p.slug.length));
  for (const product of products) {
    const paddedSlug = product.slug.padEnd(maxSlugLen);
    lines.push(`    ${import_chalk70.default.cyan(paddedSlug)}  ${product.name}`);
  }
  lines.push("");
  lines.push(`  ${import_chalk70.default.dim("Usage:")}`);
  lines.push("");
  lines.push(
    `    ${import_chalk70.default.cyan(`$ ${packageName} ${commandName} ${integrationSlug}/<product-slug>`)}`
  );
  lines.push("");
  return lines.join("\n");
}
...
function formatBillingPlansHelp(productName, plans) {
  ...
  lines.push("");
  lines.push(
    `  ${import_chalk71.default.dim("Available billing plans for")} "${import_chalk71.default.bold(productName)}"${import_chalk71.default.dim(":")}`
  );
  lines.push("");
  const maxIdLen = Math.max(...enabledPlans.map((p) => p.id.length));
  for (const plan of enabledPlans) {
    const paddedId = plan.id.padEnd(maxIdLen);
    const cost = plan.cost ? import_chalk71.default.dim(` (${plan.cost})`) : "";
    lines.push(`    ${import_chalk71.default.cyan(paddedId)}  ${plan.name}${cost}`);
  }
  lines.push("");
  lines.push(`  ${import_chalk71.default.dim("Usage:")}`);
  lines.push("");
  lines.push(`    ${import_chalk71.default.cyan(`--plan ${enabledPlans[0].id}`)}`);
  lines.push("");
  return lines.join("\n");
}
...
function formatDynamicExamples(integrationSlug, products, commandName = "integration add") {
  const lines = [];
  lines.push("");
  lines.push(`  ${import_chalk72.default.dim("Examples:")}`);
  lines.push("");
  lines.push(`  ${import_chalk72.default.dim("-")} Install ${integrationSlug}`);
  lines.push("");
  lines.push(
    `    ${import_chalk72.default.cyan(`$ ${packageName} ${commandName} ${integrationSlug}`)}`
  );
  if (products.length > 1) {
    const firstProduct = products[0];
    lines.push("");
    lines.push(`  ${import_chalk72.default.dim("-")} Install a specific product`);
    lines.push("");
    lines.push(
      `    ${import_chalk72.default.cyan(`$ ${packageName} ${commandName} ${integrationSlug}/${firstProduct.slug}`)}`
    );
  }
  lines.push("");
  lines.push(`  ${import_chalk72.default.dim("-")} Install with a custom resource name`);
  lines.push("");
  lines.push(
    `    ${import_chalk72.default.cyan(`$ ${packageName} ${commandName} ${integrationSlug} --name my-resource`)}`
  );
  ...
  if (metadataExample) {
    lines.push("");
    lines.push(`  ${import_chalk72.default.dim("-")} Install with metadata`);
    lines.push("");
    lines.push(`    ${import_chalk72.default.cyan(`$ ${metadataExample}`)}`);
  }
  lines.push("");
  lines.push(`  ${import_chalk72.default.dim("-")} Install with a specific billing plan`);
  lines.push("");
  lines.push(
    `    ${import_chalk72.default.cyan(`$ ${packageName} ${commandName} ${integrationSlug} --plan pro`)}`
  );
  lines.push("");
  lines.push(
    `  ${import_chalk72.default.dim("-")} Install and connect to specific environments only`
  );
  lines.push("");
  lines.push(
    `    ${import_chalk72.default.cyan(`$ ${packageName} ${commandName} ${integrationSlug} -e production -e preview`)}`
  );
  lines.push("");
  lines.push(
    `  ${import_chalk72.default.dim("-")} Install without connecting to the current project`
  );
  lines.push("");
  lines.push(
    `    ${import_chalk72.default.cyan(`$ ${packageName} ${commandName} ${integrationSlug} --no-connect`)}`
  );
  lines.push("");
  lines.push(
    `  ${import_chalk72.default.dim("-")} Install without pulling environment variables`
  );
  lines.push("");
  lines.push(
    `    ${import_chalk72.default.cyan(`$ ${packageName} ${commandName} ${integrationSlug} --no-env-pull`)}`
  );
  lines.push("");
  lines.push(
    `  ${import_chalk72.default.dim("-")} Install with a prefix for environment variable names`
  );
  lines.push("");
  lines.push(
    `    ${import_chalk72.default.cyan(`$ ${packageName} ${commandName} ${integrationSlug} --prefix NEON2_`)}`
  );
  lines.push("");
  lines.push(`  ${import_chalk72.default.dim("-")} Output as JSON`);
  lines.push("");
  lines.push(
    `    ${import_chalk72.default.cyan(`$ ${packageName} ${commandName} ${integrationSlug} --format=json`)}`
  );
  if (process.env.FF_AUTO_PROVISION_INSTALL !== "0") {
    lines.push("");
    lines.push(`  ${import_chalk72.default.dim("-")} Install using a specific installation`);
    lines.push("");
    lines.push(
      `    ${import_chalk72.default.cyan(`$ ${packageName} ${commandName} ${integrationSlug} --installation-id <id>`)}`
    );
  }
  lines.push("");
  return lines.join("\n");
...
async function install(client) {
  ...
  return add6(client, args.slice(1), flags, "install");
}
...
function outputBalanceInformation(prepaymentInfo, resources, integrationSlug) {
  ...
  output_manager_default.log(
    `${import_chalk73.default.bold(`Balances and thresholds for ${integrationSlug}`)}:`
  );
...
async function list4(client) {
  let parsedArguments = null;
  const flagsSpecification = getFlagsSpecification(listSubcommand9.options);
  try {
    parsedArguments = parseArguments(client.argv.slice(3), flagsSpecification);
  } catch (error) {
    printError(error);
...
`
  ...
  const headerMessage = project ? `Integration resources for project ${import_chalk74.default.bold(project.name)} in ${import_chalk74.default.bold(contextName)}:` : `Integrations in ${import_chalk74.default.bold(contextName)}:`;
  output_manager_default.log(
    `${headerMessage}
${table(
      [
        ...
        ...results.map((result) => [
          resourceLink(contextName, result) ?? import_chalk74.default.gray("\u2013"),
          resourceStatus(result.status ?? "\u2013"),
          result.product ?? import_chalk74.default.gray("\u2013"),
          integrationLink(result, team) ?? import_chalk74.default.gray("\u2013"),
          import_chalk74.default.grey(
...
function resourceStatus(status3) {
  ...
  switch (status3) {
    case "initializing":
      return import_chalk74.default.yellow(CIRCLE) + statusTitleCase;
    case "error":
      return import_chalk74.default.red(CIRCLE) + statusTitleCase;
    case "available":
      return import_chalk74.default.green(CIRCLE) + statusTitleCase;
    case "suspended":
      return import_chalk74.default.white(CIRCLE) + statusTitleCase;
    case "limits-exceeded-suspended":
      return `${import_chalk74.default.white(CIRCLE)}Limits exceeded`;
    default:
      return import_chalk74.default.gray(statusTitleCase);
  }
}
...
function integrationLink(integration, team) {
  ...
  const boldName = import_chalk74.default.bold(integration.integration);
...
async function openIntegration(client, subArgs) {
  ...
  try {
    ...
    output_manager_default.error(
      `Failed to fetch configuration for ${import_chalk75.default.bold(`"${integrationSlug}"`)}: ${error.message}`
    );
    return 1;
  } finally {
  ...
  if (!configuration) {
    output_manager_default.error(
      `No configuration found for ${import_chalk75.default.bold(`"${integrationSlug}"`)}.`
    );
    return 1;
  }
  ...
  if (resourceName) {
    ...
    if (!resource) {
      output_manager_default.error(
        `Resource ${import_chalk75.default.bold(`"${resourceName}"`)} not found for integration ${import_chalk75.default.bold(`"${integrationSlug}"`)}.`
      );
      return 1;
    }
...
`);
    ...
    const label = isResource ? `Opening the ${import_chalk75.default.bold(name)} resource dashboard...` : `Opening the ${import_chalk75.default.bold(name)} dashboard...`;
...
async function remove(client) {
  ...
  if (!integrationConfiguration) {
    output_manager_default.error(`No integration ${import_chalk76.default.bold(integrationName)} found.`);
...
`
      ...
      output_manager_default.error(
        `Cannot uninstall ${import_chalk76.default.bold(integrationName)} because it still has resources.`
      );
      if (resourceNames.length > 0) {
        output_manager_default.log("");
        output_manager_default.log("Resources that must be removed first:");
        for (const name of resourceNames) {
          output_manager_default.log(`  ${import_chalk76.default.gray("-")} ${name}`);
        }
        output_manager_default.log("");
      }
      if (client.isAgent) {
      ...
      output_manager_default.log(
        `Remove and disconnect all resources first with: ${import_chalk76.default.cyan(`${packageName} integration-resource remove <resource-name> --disconnect-all`)}`
      );
      output_manager_default.log(
        `Then retry: ${import_chalk76.default.cyan(`${packageName} integration remove ${integrationName}`)}`
      );
      return 1;
    }
    output_manager_default.error(
      import_chalk76.default.red(
        `Failed to remove ${import_chalk76.default.bold(integrationName)}: ${error.message}`
      )
    );
    return 1;
  }
...
`
  ...
  output_manager_default.success(`${import_chalk76.default.bold(integrationName)} successfully removed.`);
  return 0;
}
async function confirmIntegrationRemoval(client, integration, team) {
  output_manager_default.log(
    `The ${import_chalk76.default.bold(integration)} integration will be removed permanently from team ${import_chalk76.default.bold(team.name)}.`
  );
  ...
  return table(
    [
      ["Product Name", "Slug", "Provider", "Description"].map(
        (header) => import_chalk77.default.bold(import_chalk77.default.cyan(header))
      ),
      ...products.map((product) => [
        product.name,
        product.slug,
        product.provider,
        product.description || import_chalk77.default.gray("-")
      ])
    ],
    { hsep: 4 }
  );
...
function formatCompactList(products) {
  return products.map((product) => {
    return [
      `${import_chalk77.default.bold(product.name)} (${product.slug})`,
    ...
    if (!product) {
      ...
      if (products.length > 1) {
        ...
        for (const p of products) {
          output_manager_default.log(`  ${import_chalk78.default.cyan(p.slug)}  ${p.name}`);
        }
      }
      return 1;
    }
    ...
    if (frameworkFlag) {
      ...
      if (!selectedGuide) {
        ...
        for (const g of guides) {
          output_manager_default.log(`  ${import_chalk78.default.cyan(g.framework)}  ${g.title}`);
        }
        return 1;
      }
...
async function main11(client) {
  ...
  const {
    ...
    subcommandOriginal,
    args: subArgs
  } = getSubcommand3(args.slice(1), COMMAND_CONFIG17);
  const needHelp = flags["--help"];
  function printHelp(command) {
    output_manager_default.print(
      help(command, {
  ...
  switch (subcommand) {
    case "add": {
      const ffAutoProvision = process.env.FF_AUTO_PROVISION_INSTALL !== "0";
      const addCmd = ffAutoProvision ? addSubcommand6 : {
        ...addSubcommand6,
        options: addSubcommand6.options.filter(
          (o) => o.name !== "installation-id" && o.name !== "format"
        )
      };
      if (needHelp) {
      ...
      telemetry2.trackCliSubcommandAdd(subcommandOriginal);
      const addFlagsSpec = getFlagsSpecification(addSubcommand6.options);
      let addParsedArgs;
      try {
...
async function createThreshold(client) {
  ...
  output_manager_default.stopSpinner();
  if (!targetedResource) {
    output_manager_default.error(`The resource ${import_chalk79.default.bold(resourceName)} was not found.`);
    return 1;
  }
  if (!targetedResource.product?.integrationConfigurationId) {
    output_manager_default.error(
      `The resource ${import_chalk79.default.bold(resourceName)} does not have an integration configuration.`
    );
    return 1;
  }
  if (targetedResource.billingPlan?.type !== "prepayment") {
    output_manager_default.error(
      `The resource ${import_chalk79.default.bold(resourceName)} is not a prepayment-based resource.`
    );
    return 1;
  }
  ...
  if (targetedResource.billingPlan.scope !== "resource") {
    output_manager_default.log(
      `The resource ${import_chalk79.default.bold(resourceName)} uses an installation-level balance.`
    );
...
async function handleUpdateThreshold(props) {
  if (props.resource.billingPlan?.type !== "prepayment") {
    output_manager_default.log(
      `The resource ${import_chalk79.default.bold(props.resource.name)} is not a prepayment-based resource.`
    );
    return 0;
  }
  if (!props.resource.product?.integrationConfigurationId) {
    output_manager_default.log(
      `The resource ${import_chalk79.default.bold(props.resource.name)} does not have an integration configuration.`
    );
    return 0;
  }
  ...
  const entityTextReference = props.isInstallationLevel ? `installation ${import_chalk79.default.bold(props.resource.product?.name)}` : `resource ${import_chalk79.default.bold(props.resource.name)}`;
...
async function disconnect2(client) {
  ...
  output_manager_default.stopSpinner();
  if (!targetedResource) {
    output_manager_default.error(`No resource ${import_chalk80.default.bold(resourceName)} found.`);
    return 1;
  }
  if (parsedArguments.flags["--all"]) {
    try {
...
async function handleDisconnectProject(client, resource, projectName, skipConfirmation, asJson) {
  ...
  if (!project) {
    output_manager_default.log(
      `Could not find project ${import_chalk80.default.bold(projectName)} connected to resource ${import_chalk80.default.bold(resource.name)}.`
    );
    return 0;
  }
  if (!skipConfirmation && !client.stdin.isTTY) {
...
`
  ...
  output_manager_default.success(
    `Disconnected ${import_chalk80.default.bold(project.name)} from ${import_chalk80.default.bold(resource.name)}`
  );
  return 0;
}
async function handleDisconnectAllProjects(client, resource, skipConfirmation, asJson = false) {
  if (resource.projectsMetadata?.length === 0) {
    output_manager_default.log(`${import_chalk80.default.bold(resource.name)} has no projects to disconnect.`);
    return;
  }
  if (!skipConfirmation && !client.stdin.isTTY) {
  ...
  try {
    ...
    if (asJson) {
      ...
      output_manager_default.success(
        `Disconnected all projects from ${import_chalk80.default.bold(resource.name)}`
      );
    }
  } catch (error) {
    throw new FailedError(
...
async function confirmDisconnectProject(client, resource, project) {
  output_manager_default.log(
    `The resource ${import_chalk80.default.bold(resource.name)} will be disconnected from project ${import_chalk80.default.bold(project.name)}.`
  );
  return client.input.confirm(`${import_chalk80.default.red("Are you sure?")}`, false);
}
...
async function remove2(client) {
  ...
  output_manager_default.stopSpinner();
  if (!targetedResource) {
    output_manager_default.error(`No resource ${import_chalk81.default.bold(resourceName)} found.`);
    return 1;
  }
  if (disconnectAll) {
    try {
...
async function handleDeleteResource(client, resource, options) {
  ...
  if (!options?.skipProjectCheck && hasProjects) {
    output_manager_default.error(
      `Cannot delete resource ${import_chalk81.default.bold(resource.name)} while it has connected projects. Please disconnect any projects using this resource first or use the \`--disconnect-all\` flag.`
    );
    return 1;
  }
  ...
  try {
    ...
    output_manager_default.error(
      `A problem occurred when attempting to delete ${import_chalk81.default.bold(resource.name)}: ${error.message}`
    );
    return 1;
  }
  if (options?.asJson) {
...
`
  ...
  output_manager_default.success(`${import_chalk81.default.bold(resource.name)} successfully deleted.`);
  return 0;
}
async function confirmDeleteResource(client, resource) {
  output_manager_default.log(`${import_chalk81.default.bold(resource.name)} will be deleted permanently.`);
  return client.input.confirm(`${import_chalk81.default.red("Are you sure?")}`, false);
}
...
async function logs(client) {
  ...
  if (followOption) {
    ...
    const usedIncompatible = incompatibleFlags.filter((f) => f.value !== void 0 && f.value !== null).map((f) => import_chalk82.default.bold(f.flag));
    if (usedIncompatible.length > 0) {
      output_manager_default.error(
        `The ${import_chalk82.default.bold("--follow")} flag does not support filtering. Remove: ${usedIncompatible.join(", ")}`
      );
      return 1;
    }
  }
    ...
    if (link.status === "error") {
      ...
      output_manager_default.error(
        `Your codebase isn't linked to a project on Vercel. Run ${getCommandName(
          "link"
        )} to begin, or specify a project with ${import_chalk82.default.bold("--project")}.`
      );
      return 1;
    }
    client.config.currentTeam = link.org.type === "team" ? link.org.id : void 0;
  ...
  if (followOption) {
    if (!deploymentId) {
      if (noBranchFlagValue) {
        output_manager_default.error(
          `The ${import_chalk82.default.bold("--follow")} flag requires a deployment. Specify one with ${import_chalk82.default.bold("--deployment")} or remove ${import_chalk82.default.bold("--no-branch")} to auto-detect from the current git branch.`
        );
        return 1;
      }
      if (!branchOption) {
        output_manager_default.error(
          `The ${import_chalk82.default.bold("--follow")} flag requires a deployment. Specify one with ${import_chalk82.default.bold("--deployment")} or run from within a git repository.`
        );
        return 1;
      }
      output_manager_default.spinner(
      ...
      if (!branchDeployment) {
        output_manager_default.error(
          `No deployments found for branch "${branchOption}". Deploy this branch first or specify a deployment with ${import_chalk82.default.bold("--deployment")}.`
        );
        return 1;
      }
    ...
    if (!jsonOption) {
      output_manager_default.print(
        `Streaming logs for deployment ${import_chalk82.default.bold(deploymentId)} starting from ${import_chalk82.default.bold((0, import_date_fns2.format)(Date.now(), TIME_ONLY_FORMAT))}
...
`
  ...
  output_manager_default.stopSpinner();
  if (!jsonOption) {
    const branchSuffix = branchOption ? ` on branch ${import_chalk82.default.cyan(branchOption)}` : "";
    if (logs2.length === 0) {
      output_manager_default.print(
        import_chalk82.default.dim(
...
`
      ...
      const baseColumns = [
        {
          ...
          format: (padded) => import_chalk82.default.dim(padded)
        },
        {
          label: "HOST",
      ...
      const columns = expandOption ? baseColumns : [
        ...baseColumns,
        {
          ...
          format: (padded, row) => row.statusCode <= 0 ? import_chalk82.default.gray(padded) : colorizeStatus(padded, row.statusCode)
        },
        {
          label: "MESSAGE",
          width: "stretch",
          getValue: (row) => row.message || "(no message)",
          format: (padded, row) => row.message ? colorizeMessage(padded, row.level) : import_chalk82.default.dim(padded)
        }
      ];
      const formatted = table2({
        ...
        formatHeader: (header) => import_chalk82.default.dim(header),
        formatRow: expandOption ? (rowStr, row) => {
          if (row.message) {
            const coloredMessage = colorizeMessage(row.message, row.level);
            const truncatedIndicator = row.messageTruncated ? import_chalk82.default.gray("\u2026") : "";
            return `${rowStr}
...
function colorizeLevel(formatted, level) {
  switch (level) {
    case "fatal":
      return import_chalk82.default.red.bold(formatted);
    case "error":
      return import_chalk82.default.red(formatted);
    case "warning":
      return import_chalk82.default.yellow(formatted);
    default:
      return import_chalk82.default.dim(formatted);
  }
}
function colorizeStatus(formatted, statusCode) {
  if (statusCode >= 500) {
    ...
    return import_chalk82.default.cyan(formatted);
  } else if (statusCode >= 200) {
    return import_chalk82.default.green(formatted);
  }
  return import_chalk82.default.gray(formatted);
}
...
function colorizeMessage(message, level) {
  switch (level) {
    case "fatal":
    case "error":
      return import_chalk82.default.red(message);
    case "warning":
      return import_chalk82.default.yellow(message);
    default:
      return import_chalk82.default.dim(message);
  }
}
...
async function metrics(client) {
  ...
  switch (subcommand) {
    ...
    default: {
      ...
      const queryFn = (await import("./chunks/query-GX4TELM3.js")).default;
...
async function pull2(client) {
  ...
  const { contextName } = await getScope(client);
  output_manager_default.spinner(
    `Fetching microfrontends configuration in ${import_chalk83.default.bold(contextName)}`
  );
  let rawConfig;
  ...
  try {
    ...
    output_manager_default.print(
      `${prependEmoji(
        `Downloaded microfrontends configuration to ${import_chalk83.default.bold(
          humanizePath(
            join4(currentDirectory, VERCEL_DIR, VERCEL_DIR_MICROFRONTENDS)
          )
        )} ${import_chalk83.default.gray(microfrontendsStamp())}`,
        emoji("success")
      )}
`
    );
...
async function add7(client, argv) {
  ...
  let parsedArgs;
  const flagsSpecification = getFlagsSpecification(addSubcommand7.options);
  try {
    parsedArgs = parseArguments(argv, flagsSpecification);
  } catch (error) {
    printError(error);
  ...
  if (args.length !== 1) {
    ...
    if (args.length > 1) {
      const example = import_chalk84.default.cyan(
  ...
  const { contextName } = await getScope(client);
  output_manager_default.log(
    `${import_chalk84.default.cyan("Success!")} Project ${import_chalk84.default.bold(
      name.toLowerCase()
    )} added (${import_chalk84.default.bold(contextName)}) ${import_chalk84.default.gray(`[${elapsed2}]`)}`
  );
  return 0;
}
...
async function inspect4(client, argv) {
  ...
  const projectSlugLink = formatProject(org.slug, project.name);
  output_manager_default.log(`Found Project ${projectSlugLink} ${import_chalk85.default.gray(inspectStamp())}`);
  output_manager_default.print("\n");
  output_manager_default.print(import_chalk85.default.bold("  General\n\n"));
  output_manager_default.print(`    ${import_chalk85.default.cyan("ID")}				${project.id}
`);
  output_manager_default.print(`    ${import_chalk85.default.cyan("Name")}			${project.name}
`);
  output_manager_default.print(`    ${import_chalk85.default.cyan("Owner")}			${org.name}
`);
  output_manager_default.print(
    `    ${import_chalk85.default.cyan("Created At")}			${formatDate(project.createdAt)}
`
  );
  output_manager_default.print(
    `    ${import_chalk85.default.cyan("Root Directory")}		${project.rootDirectory ?? "."}
`
  );
  output_manager_default.print(
    `    ${import_chalk85.default.cyan("Node.js Version")}		${project.nodeVersion}
`
  );
  const framework = import_frameworks.frameworkList.find((f) => f.slug === project.framework);
  output_manager_default.print("\n");
  output_manager_default.print(import_chalk85.default.bold("  Framework Settings\n\n"));
  output_manager_default.print(`    ${import_chalk85.default.cyan("Framework Preset")}		${framework?.name}
`);
  output_manager_default.print(
    `    ${import_chalk85.default.cyan("Build Command")}		${project.buildCommand ?? import_chalk85.default.dim(framework?.settings?.buildCommand.placeholder ?? "None")}
`
  );
  output_manager_default.print(
    `    ${import_chalk85.default.cyan("Output Directory")}		${project.outputDirectory ?? import_chalk85.default.dim(framework?.settings?.outputDirectory.placeholder ?? "None")}
`
  );
  output_manager_default.print(
    `    ${import_chalk85.default.cyan("Install Command")}		${project.installCommand ?? import_chalk85.default.dim(framework?.settings?.installCommand.placeholder ?? "None")}
`
  );
  output_manager_default.print("\n");
  return 0;
...
async function list5(client, argv) {
  ...
  const start = Date.now();
  const { contextName } = await getScope(client);
  output_manager_default.spinner(`Fetching projects in ${import_chalk86.default.bold(contextName)}`);
...
function outputTable(projectList, options) {
  ...
  output_manager_default.log(
    `${projectList.length > 0 ? "Projects" : "No projects"} found under ${import_chalk86.default.bold(contextName)} ${deprecated ? "that are using a deprecated Node.js version" : "\b"} ${import_chalk86.default.gray(`[${elapsed2}]`)}`
  );
...
function printProjectsTable(projectList) {
  const tablePrint = table(
    [
      TABLE_HEADERS.map((header) => import_chalk86.default.bold(import_chalk86.default.cyan(header))),
      ...projectList.flatMap((project) => [
        [
          import_chalk86.default.bold(project.name),
          getLatestProdUrl(project),
          import_chalk86.default.gray((0, import_ms16.default)(Date.now() - project.updatedAt)),
          project.nodeVersion ?? ""
        ]
      ])
    ],
...
async function rm6(client, argv) {
  ...
  if (args.length !== 1) {
    output_manager_default.error(
      `Invalid number of arguments. Usage: ${import_chalk87.default.cyan(
  ...
  output_manager_default.log(
    `${import_chalk87.default.cyan("Success!")} Project ${import_chalk87.default.bold(name)} removed ${import_chalk87.default.gray(
      `[${elapsed2}]`
    )}`
  );
  return 0;
...
async function readConfirmation3(client, projectName) {
  output_manager_default.print(
    prependEmoji(
      `The project ${import_chalk87.default.bold(projectName)} will be removed permanently.
...
`,
  ...
  return await client.input.confirm(
    `${import_chalk87.default.bold.red("Are you sure?")}`,
    false
  );
}
...
async function main15(client) {
  ...
  switch (subcommand) {
    ...
    case "list":
      if (needHelp) {
        telemetry2.trackCliFlagHelp("project", subcommandOriginal);
        return printHelp(listSubcommand10);
      }
      telemetry2.trackCliSubcommandList(subcommandOriginal);
...
async function getProjectByDeployment({
  ...
  try {
    output_manager_default?.spinner(
      `Fetching deployment "${deployId}" in ${import_chalk89.default.bold(contextName)}\u2026`
    );
...
function renderAliasStatus(status3) {
  if (status3 === "completed") {
    return import_chalk90.default.green(status3);
  }
  if (status3 === "failed") {
    return import_chalk90.default.red(status3);
  }
  if (status3 === "skipped") {
    return import_chalk90.default.gray(status3);
  }
  return import_chalk90.default.yellow(status3);
}
  ...
  try {
    ...
    for (; ; ) {
      ...
      if (requestedAt < recentThreshold || Date.now() >= promoteTimeout) {
        output_manager_default.log(
          `The promotion exceeded its deadline - rerun ${import_chalk91.default.bold(
...
async function renderJobSucceeded({
  ...
  try {
    ...
    deploymentInfo = `${import_chalk91.default.bold(deployment.url)} (${toDeploymentId})`;
  } catch (err) {
    output_manager_default.debug(
      `Failed to get deployment url for ${toDeploymentId}: ${err?.toString() || err}`
    );
    deploymentInfo = import_chalk91.default.bold(toDeploymentId);
  }
  const duration = performingPromote ? elapsed(Date.now() - requestedAt) : "";
  output_manager_default.log(
    `Success! ${import_chalk91.default.bold(
      project.name
...
async function requestPromote({
  ...
  if (promoteByCreation) {
    ...
    output_manager_default.log(
      `Successfully created new deployment of ${import_chalk92.default.bold(project.name)} at ${newDeployment.inspectorUrl}`
    );
    return 0;
  }
  const res = await client.fetch(
  ...
  if (timeout !== void 0 && (0, import_ms19.default)(timeout) === 0) {
    output_manager_default.log(
      `Successfully requested promote of ${import_chalk92.default.bold(project.name)} to ${deployment.url} (${deployment.id})`
    );
...
async function getDeploymentByIdOrURL({
  ...
  try {
    output_manager_default.spinner(
      `Fetching deployment "${deployIdOrUrl}" in ${import_chalk93.default.bold(contextName)}\u2026`
    );
    const [teamResult, deploymentResult] = await Promise.allSettled([
      config.currentTeam ? getTeamById(client, config.currentTeam) : void 0,
  ...
  if (deployment.team?.id) {
    if (!team || deployment.team.id !== team.id) {
      const err = new Error(
        team ? `Deployment doesn't belong to current team ${import_chalk93.default.bold(
          contextName
        )}` : `Deployment belongs to a different team`
      );
      err.code = "ERR_INVALID_TEAM";
    ...
    const err = new Error(
      `Deployment doesn't belong to current team ${import_chalk93.default.bold(contextName)}`
    );
    err.code = "ERR_INVALID_TEAM";
    throw err;
  }
...
async function redeploy(client) {
  ...
  try {
    ...
    output_manager_default.print(
      `${prependEmoji(
        `Inspect: ${import_chalk94.default.bold(deployment.inspectorUrl)} ${deployStamp()}`,
        emoji("inspect")
      )}
`
    );
    output_manager_default.print(
      prependEmoji(
        `${isProdDeployment ? "Production" : "Preview"}: ${import_chalk94.default.bold(
          previewUrl
        )} ${deployStamp()}`,
        emoji("success")
      ) + `
`
          ...
          for await (const event of (0, import_client.checkDeploymentStatus)(
            ...
            if (event.type === "building") {
              ...
              if (event.type === "alias-assigned" && !Array.isArray(event.payload) && event.payload.target === "production" && event.payload.alias && event.payload.alias.length > 0) {
                ...
                output_manager_default.print(
                  prependEmoji(
                    `Aliased: ${import_chalk94.default.bold(prodUrl)} ${deployStamp()}`,
                    emoji("link")
                  ) + "\n"
                );
              }
    ...
    if ((0, import_error_utils14.isErrnoException)(err) && err.code === "ERR_INVALID_TEAM") {
      output_manager_default.error(
        `Use ${import_chalk94.default.bold("vc switch")} to change your current team`
      );
    }
    return 1;
  }
...
async function list6(client, argv) {
  const parsed = await parseSubcommandArgs2(argv, listSubcommand11);
  ...
  if (staging) {
    ...
    if (!stagingVersion) {
      output_manager_default.error(
        `No staging version found for ${import_chalk95.default.bold(project.name)}. Run ${import_chalk95.default.cyan(
  ...
  if (versionIdFlag) {
    ...
    if (!version) {
      output_manager_default.error(
        `Version "${versionIdFlag}" not found. Run ${import_chalk95.default.cyan(
          "vercel redirects list-versions"
        )} to see available versions.`
      );
      return 1;
  ...
  const lsStamp = stamp_default();
  let spinnerMessage = `Fetching redirects for ${import_chalk95.default.bold(project.name)}`;
  if (versionName) {
  ...
  if (useDiff) {
    ...
    output_manager_default.log(
      `Changes in staging version ${import_chalk95.default.bold(versionName || "")} ${import_chalk95.default.gray(lsStamp())}`
    );
    if (added.length === 0 && removed.length === 0) {
      ...
      if (added.length > 0) {
        output_manager_default.print(`
  ${import_chalk95.default.bold(import_chalk95.default.green(`Added (${added.length}):`))}
`);
        output_manager_default.print(formatRedirectsTable(added, "+"));
      }
      if (removed.length > 0) {
        output_manager_default.print(`
  ${import_chalk95.default.bold(import_chalk95.default.red(`Removed (${removed.length}):`))}
`);
      ...
      if (unchanged.length > 0) {
        output_manager_default.print(
          `
  ${import_chalk95.default.gray(`${unchanged.length} redirect${unchanged.length === 1 ? "" : "s"} unchanged`)}
`
        );
      }
      output_manager_default.print("\n");
    ...
    let resultMessage = `${(0, import_pluralize9.default)("Redirect", redirects.length, true)} found for ${import_chalk95.default.bold(
      project.name
    )}`;
    if (versionName) {
      resultMessage += ` ${import_chalk95.default.gray(`(version: ${versionName})`)}`;
    }
    if (search) {
      resultMessage += ` matching "${search}"`;
    }
    if (pagination) {
      resultMessage += ` ${import_chalk95.default.gray(`(page ${pagination.page} of ${pagination.numPages})`)}`;
    }
    resultMessage += ` ${import_chalk95.default.gray(lsStamp())}`;
...
function formatRedirectsTable(redirects, actionSymbol) {
  const rows = redirects.map((redirect) => {
    ...
    const colorFn = actionSymbol === "+" ? import_chalk95.default.green : actionSymbol === "-" ? import_chalk95.default.red : (s) => s;
    return [
...
async function listVersions(client, argv) {
  ...
  output_manager_default.log(
    `${(0, import_pluralize10.default)("Version", sortedVersions.length, true)} found for ${import_chalk96.default.bold(
      project.name
    )} ${import_chalk96.default.gray(lsStamp())}`
  );
...
function formatVersionsTable(versions) {
  ...
  const rows = versions.map((version) => {
    ...
    if (version.isStaging) {
      status3 = import_chalk96.default.yellow("Staging");
    } else if (version.isLive) {
      status3 = import_chalk96.default.green("Live");
    } else {
      status3 = import_chalk96.default.gray("Previous");
    }
    const name = version.name || import_chalk96.default.gray("(unnamed)");
    const redirectCountStr = version.redirectCount !== void 0 && version.redirectCount !== null ? version.redirectCount.toString() : import_chalk96.default.gray("-");
    return [
      status3,
      name,
      version.id,
      redirectCountStr,
      version.createdBy || import_chalk96.default.gray("(unknown)"),
      import_chalk96.default.gray(age + " ago")
    ];
  });
  return formatTable(
...
async function add8(client, argv) {
  const parsed = await parseSubcommandArgs2(argv, addSubcommand8);
  if (typeof parsed === "number")
    return parsed;
  const link = await ensureProjectLink2(client);
  if (typeof link === "number")
  ...
  output_manager_default.log(`${import_chalk97.default.cyan("\u2713")} Redirect added ${import_chalk97.default.gray(addStamp())}`);
  output_manager_default.print(`
  ${import_chalk97.default.bold("Redirect:")}
`);
  output_manager_default.print(`    ${import_chalk97.default.cyan(source)} \u2192 ${import_chalk97.default.cyan(destination)}
`);
...
`
  ...
  if (alias2) {
    ...
    output_manager_default.print(
      `
  ${import_chalk97.default.bold("Test your changes:")} ${import_chalk97.default.cyan(testUrl)}
`
    );
  }
  const newVersionName = version.name || version.id;
  output_manager_default.print(`  ${import_chalk97.default.bold("New staging version:")} ${newVersionName}
...
`);
  if (!existingStagingVersion) {
    ...
    if (shouldPromote) {
      ...
      output_manager_default.log(
        `${import_chalk97.default.cyan("\u2713")} Version promoted to production ${import_chalk97.default.gray(promoteStamp())}`
      );
    }
  } else {
    output_manager_default.warn(
      `There are other staged changes. Please review all changes with ${import_chalk97.default.cyan("vercel redirects list --staging")} before promoting to production.`
    );
  }
  return 0;
}
...
async function upload(client, argv) {
  ...
  try {
    ...
    output_manager_default.log(
      `${import_chalk98.default.cyan("\u2713")} Redirects uploaded ${import_chalk98.default.gray(uploadStamp())}`
    );
    ...
    output_manager_default.print(`
  ${import_chalk98.default.bold("Summary:")}
`);
    output_manager_default.print(
...
`
    ...
    if (redirectCount > 0) {
      ...
      output_manager_default.print(`
  ${import_chalk98.default.bold("Changes:")}
`);
      if (added.length > 0) {
        output_manager_default.print(`    ${import_chalk98.default.green(`Added: ${added.length}`)}
`);
      }
      if (deleted.length > 0) {
        output_manager_default.print(`    ${import_chalk98.default.red(`Deleted: ${deleted.length}`)}
`);
      }
      if (edited.length > 0) {
        output_manager_default.print(`    ${import_chalk98.default.yellow(`Modified: ${edited.length}`)}
`);
      }
      output_manager_default.print(`
  ${import_chalk98.default.bold("Redirect changes:")}
`);
      ...
      const rows = displayRedirects.map((redirect) => {
        ...
        switch (action) {
          case "+":
            colorFn = import_chalk98.default.green;
            actionSymbol = "+";
            break;
          case "-":
            colorFn = import_chalk98.default.red;
            actionSymbol = "-";
            break;
          case "~":
            colorFn = import_chalk98.default.yellow;
            actionSymbol = "~";
            break;
          default:
            colorFn = (s) => s;
      ...
      if (redirectCount > 100) {
        output_manager_default.print(
          `
  ${import_chalk98.default.gray(`... and ${redirectCount - 100} more redirect${redirectCount - 100 === 1 ? "" : "s"}`)}
`
        );
      }
    }
    if (result.alias) {
      ...
      output_manager_default.print(
        `
  ${import_chalk98.default.bold("Test your changes:")} ${import_chalk98.default.cyan(testUrl)}
`
      );
    }
    const newVersionName = result.version.name || result.version.id;
    output_manager_default.print(
      `  ${import_chalk98.default.bold("New staging version:")} ${newVersionName}

`
    );
    if (existingStagingVersion) {
      output_manager_default.warn(
        `There are other staged changes. Please review all changes with ${import_chalk98.default.cyan("vercel redirects list --staging")} before promoting to production.`
      );
    } else if (!skipPrompts) {
      const shouldPromote = await client.input.confirm(
        "This is the only staged change. Do you want to promote it to production now?",
      ...
      if (shouldPromote) {
        ...
        output_manager_default.log(
          `${import_chalk98.default.cyan("\u2713")} Version promoted to production ${import_chalk98.default.gray(promoteStamp())}`
        );
      }
    }
    return 0;
...
async function remove3(client, argv) {
  ...
  if (!redirectToRemove) {
    output_manager_default.error(
      `Redirect with source "${source}" not found. Run ${import_chalk99.default.cyan(
  ...
  output_manager_default.print(`
  ${import_chalk99.default.bold("Removing redirect:")}
`);
  output_manager_default.print(
    `    ${import_chalk99.default.cyan(redirectToRemove.source)} \u2192 ${import_chalk99.default.cyan(redirectToRemove.destination)}
`
  );
...
`);
  ...
  const removeStamp = stamp_default();
  output_manager_default.spinner(`Removing redirect for ${import_chalk99.default.bold(source)}`);
  ...
  output_manager_default.log(
    `${import_chalk99.default.cyan("\u2713")} Redirect removed ${import_chalk99.default.gray(removeStamp())}`
  );
  if (alias2) {
    const testUrl = source.startsWith("/") ? `https://${alias2}${source}` : `https://${alias2}`;
    output_manager_default.print(
      `
  ${import_chalk99.default.bold("Test your changes:")} ${import_chalk99.default.cyan(testUrl)}
`
    );
    output_manager_default.print(
...
`
  ...
  output_manager_default.print(`  ${import_chalk99.default.bold("New staging version:")} ${versionName}
...
`);
  if (!existingStagingVersion) {
    ...
    if (shouldPromote) {
      ...
      output_manager_default.log(
        `${import_chalk99.default.cyan("\u2713")} Version promoted to production ${import_chalk99.default.gray(promoteStamp())}`
      );
    }
  } else {
    output_manager_default.warn(
      `There are other staged changes. Review them with ${import_chalk99.default.cyan("vercel redirects list --staging")} before promoting to production.`
    );
  }
  return 0;
}
...
async function promote(client, argv) {
  ...
  output_manager_default.spinner(`Fetching redirect versions for ${import_chalk100.default.bold(project.name)}`);
  const { versions } = await getRedirectVersions(client, project.id, teamId);
  const version = versions.find(
  ...
  if (!version) {
    output_manager_default.error(
      `Version with ID or name "${versionIdentifier}" not found. Run ${import_chalk100.default.cyan(
        "vercel redirects list-versions"
      )} to see available versions.`
    );
    return 1;
  ...
  if (version.isLive) {
    output_manager_default.error(
      `Version ${import_chalk100.default.bold(version.name || version.id)} is already live.`
    );
    return 1;
  }
  if (!version.isStaging) {
    output_manager_default.error(
      `Version ${import_chalk100.default.bold(
        version.name || version.id
      )} is not staged. Only staging versions can be promoted to production.
Run ${import_chalk100.default.cyan(
        "vercel redirects list-versions"
  ...
  if (changedRedirects.length > 0) {
    output_manager_default.print(`
${import_chalk100.default.bold("Changes to be promoted:")}

`);
    const displayRedirects = changedRedirects.slice(0, 20);
    for (const redirect of displayRedirects) {
      const status3 = redirect.statusCode || (redirect.permanent ? 308 : 307);
      const symbol = redirect.action === "+" ? import_chalk100.default.green("+") : import_chalk100.default.red("-");
      output_manager_default.print(
...
`)
    ...
    output_manager_default.print(
      `
${import_chalk100.default.gray("No changes detected from current production version.")}
...
`
  ...
  const confirmed = await confirmAction(
    client,
    parsed.flags["--yes"],
    `Promote version ${import_chalk100.default.bold(versionName)} to production?`,
    `This will make it the live version for ${import_chalk100.default.bold(project.name)}.`
  );
  if (!confirmed) {
    output_manager_default.log("Canceled");
    return 0;
  ...
  output_manager_default.spinner(`Promoting version ${import_chalk100.default.bold(versionName)} to production`);
  ...
  output_manager_default.log(
    `${import_chalk100.default.cyan("\u2713")} Version ${import_chalk100.default.bold(
      newVersion.name || newVersion.id
    )} promoted to production ${import_chalk100.default.gray(updateStamp())}`
  );
  return 0;
}
...
async function restore(client, argv) {
  ...
  const teamId = org.type === "team" ? org.id : void 0;
  const [versionIdentifier] = parsed.args;
  output_manager_default.spinner(`Fetching redirect versions for ${import_chalk101.default.bold(project.name)}`);
  const { versions } = await getRedirectVersions(client, project.id, teamId);
  const version = versions.find(
    (v) => v.id === versionIdentifier || v.name === versionIdentifier
  );
  if (!version) {
    output_manager_default.error(
      `Version with ID or name "${versionIdentifier}" not found. Run ${import_chalk101.default.cyan(
        "vercel redirects list-versions"
      )} to see available versions.`
    );
    return 1;
  ...
  if (version.isLive) {
    output_manager_default.error(
      `Version ${import_chalk101.default.bold(
        version.name || version.id
      )} is currently live. You cannot restore the live version.
Run ${import_chalk101.default.cyan(
        "vercel redirects list-versions"
  ...
  if (changedRedirects.length > 0) {
    output_manager_default.print(`
${import_chalk101.default.bold("Changes to be restored:")}

`);
    const displayRedirects = changedRedirects.slice(0, 20);
    for (const redirect of displayRedirects) {
      const status3 = redirect.statusCode || (redirect.permanent ? 308 : 307);
      const symbol = redirect.action === "+" ? import_chalk101.default.green("+") : import_chalk101.default.red("-");
      output_manager_default.print(
        `  ${symbol} ${redirect.source} \u2192 ${redirect.destination} (${status3})
`
      );
...
`)
    ...
    output_manager_default.print(
      `
${import_chalk101.default.gray("No changes detected from current production version.")}
...
`
  ...
  const confirmed = await confirmAction(
    client,
    parsed.flags["--yes"],
    `Restore version ${import_chalk101.default.bold(versionName)}?`,
    `This will make it the live version for ${import_chalk101.default.bold(project.name)}.`
  );
  if (!confirmed) {
    output_manager_default.log("Canceled");
    return 0;
  ...
  const updateStamp = stamp_default();
  output_manager_default.spinner(`Restoring version ${import_chalk101.default.bold(versionName)}`);
  const { version: newVersion } = await updateRedirectVersion(
    client,
    project.id,
    version.id,
  ...
  output_manager_default.log(
    `${import_chalk101.default.cyan("\u2713")} Version ${import_chalk101.default.bold(
      newVersion.name || newVersion.id
    )} restored to production ${import_chalk101.default.gray(updateStamp())}`
  );
  return 0;
}
...
async function remove4(client) {
  ...
  if (deployments.length === 0 && projects.length === 0) {
    ...
    const stylizedIds = ids.map((id) => import_chalk102.default.bold(`"${id}"`)).join(", ");
  ...
  deployments.forEach((depl) => {
    output_manager_default.print(`${import_chalk102.default.gray("-")} ${import_chalk102.default.bold(depl.url)}
`);
  });
  projects.forEach((project) => {
    output_manager_default.print(`${import_chalk102.default.gray("-")} ${import_chalk102.default.bold(project.name)}
`);
  });
  return 0;
}
    ...
    if (deployments.length > 0) {
      ...
      const deploymentTable = table(
        deployments.map((depl) => {
          const time = import_chalk102.default.gray(`${(0, import_ms22.default)(Date.now() - depl.createdAt)} ago`);
          const url = depl.url ? import_chalk102.default.underline(`https://${depl.url}`) : "";
...
async function rollingRelease(client) {
  ...
  const {
    ...
    args: subcommandArgs,
    subcommandOriginal
  } = getSubcommand3(client.argv.slice(3), COMMAND_CONFIG23);
...
async function list7(client, argv) {
  ...
  if (production) {
    ...
    if (!productionVersion) {
      output_manager_default.error(
        `No production version found for ${import_chalk105.default.bold(project.name)}.`
      );
      return 1;
    }
  ...
  if (diffFlag && !versionIdFlag) {
    ...
    if (!stagingVersion) {
      output_manager_default.error(
        `No staged changes to diff. Run ${import_chalk105.default.cyan(
          getCommandName("routes add")
        )} or ${import_chalk105.default.cyan(getCommandName("routes edit"))} to make changes.`
      );
      return 1;
    }
    versionId = stagingVersion.id;
  ...
  const lsStamp = stamp_default();
  let spinnerMessage = `Fetching routes for ${import_chalk105.default.bold(project.name)}`;
  if (versionName) {
    spinnerMessage += ` (version: ${versionName})`;
  }
  if (search) {
  ...
  if (useDiff) {
    ...
    output_manager_default.log(
      `Changes in staging version ${import_chalk105.default.bold(versionName || "")} ${import_chalk105.default.gray(lsStamp())}`
    );
    if (added.length === 0 && removed.length === 0 && modified.length === 0) {
      ...
      if (added.length > 0) {
        output_manager_default.print(
          `
  ${import_chalk105.default.bold(import_chalk105.default.green(`Added (${added.length}):`))}
`
        );
      ...
      if (modified.length > 0) {
        output_manager_default.print(
          `
  ${import_chalk105.default.bold(import_chalk105.default.yellow(`Modified (${modified.length}):`))}
`
        );
      ...
      if (removed.length > 0) {
        output_manager_default.print(
          `
  ${import_chalk105.default.bold(import_chalk105.default.red(`Removed (${removed.length}):`))}
`
        );
      ...
      if (unchanged.length > 0) {
        output_manager_default.print(
          `
  ${import_chalk105.default.gray(`${unchanged.length} route${unchanged.length === 1 ? "" : "s"} unchanged`)}
`
        );
      }
      output_manager_default.print("\n");
    ...
    if (version?.alias) {
      output_manager_default.log(
        `Test your changes: ${import_chalk105.default.cyan(`https://${version.alias}`)}`
      );
    }
  } else {
    let resultMessage = `${(0, import_pluralize12.default)("Route", routes2.length, true)} found for ${import_chalk105.default.bold(
      project.name
    )}`;
    if (versionName) {
      resultMessage += ` ${import_chalk105.default.gray(`(version: ${versionName})`)}`;
    }
    if (search) {
      resultMessage += ` matching "${search}"`;
    }
    ...
    resultMessage += ` ${import_chalk105.default.gray(lsStamp())}`;
    output_manager_default.log(resultMessage);
    if (routes2.length > 0) {
      if (expand) {
    ...
    if (limit && limit.maxRoutes > 0) {
      ...
      if (utilization >= 0.8) {
        const usageColor = utilization >= 1 ? import_chalk105.default.red : import_chalk105.default.yellow;
        output_manager_default.print(
...
function formatRoutesTable(routes2, actionSymbol) {
  const rows = routes2.map((rule, index) => {
    ...
    const status3 = rule.enabled === false ? import_chalk105.default.red("Disabled") : import_chalk105.default.green("Enabled");
    const prefix = actionSymbol || "";
    const colorFn = actionSymbol === "+" ? import_chalk105.default.green : actionSymbol === "-" ? import_chalk105.default.red : actionSymbol === "~" ? import_chalk105.default.yellow : (s) => s;
    const position = actionSymbol ? "" : `${index + 1}`;
    return [
      colorFn(`${prefix} ${position}`).trim(),
      colorFn(
        truncate(rule.name, 30) + (rule.staged ? import_chalk105.default.yellow(" (draft)") : "")
      ),
...
function formatExpandedRoutes(routes2) {
  ...
  routes2.forEach((rule, index) => {
    ...
    const statusText = rule.enabled === false ? import_chalk105.default.red("Disabled") : import_chalk105.default.green("Enabled");
    const stagedText = rule.staged ? import_chalk105.default.yellow(" (staged)") : "";
    lines.push(
      `  ${import_chalk105.default.bold(`${index + 1}. ${rule.name}`)}${stagedText}  ${import_chalk105.default.gray(`[${rule.id}]`)}`
    );
    lines.push(`     ${import_chalk105.default.cyan("Status:")}  ${statusText}`);
    lines.push(`     ${import_chalk105.default.cyan("Type:")}    ${typeLabels}`);
    if (rule.description) {
      lines.push(`     ${import_chalk105.default.cyan("Desc:")}    ${rule.description}`);
    }
    lines.push(`     ${import_chalk105.default.cyan("Source:")}  ${rule.route.src}`);
    lines.push(`     ${import_chalk105.default.cyan("Syntax:")}  ${syntaxLabel}`);
    if (rule.route.dest) {
      lines.push(`     ${import_chalk105.default.cyan("Dest:")}    ${rule.route.dest}`);
    }
    if (rule.route.status) {
      lines.push(`     ${import_chalk105.default.cyan("Code:")}    ${rule.route.status}`);
    }
    if (rule.route.headers && Object.keys(rule.route.headers).length > 0) {
      lines.push(`     ${import_chalk105.default.cyan("Response Headers:")}`);
      for (const [key, value] of Object.entries(rule.route.headers)) {
        lines.push(`       ${key}: ${value}`);
      }
    }
    if (rule.route.transforms && rule.route.transforms.length > 0) {
      lines.push(`     ${import_chalk105.default.cyan("Transforms:")}`);
    ...
    if (rule.route.has && rule.route.has.length > 0) {
      lines.push(`     ${import_chalk105.default.cyan("Has conditions:")}`);
    ...
    if (rule.route.missing && rule.route.missing.length > 0) {
      lines.push(`     ${import_chalk105.default.cyan("Does not have conditions:")}`);
...
async function listVersions2(client, argv) {
  ...
  const lsStamp = stamp_default();
  output_manager_default.spinner(`Fetching route versions for ${import_chalk106.default.bold(project.name)}`);
  const { versions } = await getRouteVersions(client, project.id, {
    teamId,
    count
  });
  output_manager_default.log(
    `Route versions for ${import_chalk106.default.bold(project.name)} ${import_chalk106.default.gray(lsStamp())}`
  );
...
function formatVersionsTable2(versions) {
  const rows = versions.map((version) => {
    let status3 = "";
    if (version.isStaging) {
      status3 = import_chalk106.default.yellow("Staging");
    } else if (version.isLive) {
      status3 = import_chalk106.default.green("Live");
    } else {
      status3 = import_chalk106.default.gray("Previous");
    }
...
async function inspect5(client, argv) {
  ...
  if (!identifier) {
    output_manager_default.error(
      `Missing route name or ID. Usage: ${import_chalk107.default.cyan(getCommandName("routes inspect <name-or-id>"))}`
    );
    return 1;
  }
  const inspectStamp = stamp_default();
  output_manager_default.spinner(
    `Searching for route "${identifier}" in ${import_chalk107.default.bold(project.name)}`
  );
  ...
  if (exactMatch) {
    ...
    output_manager_default.error(
      `No route found matching "${identifier}". Run ${import_chalk107.default.cyan(
    ...
    output_manager_default.log(
      `Found ${routes2.length} routes matching "${identifier}" ${import_chalk107.default.gray(inspectStamp())}`
    );
    const selectedId = await client.input.select({
      message: "Select a route to inspect:",
      choices: routes2.map((r) => ({
        value: r.id,
        name: `${r.name} ${import_chalk107.default.gray(`(${r.route.src})`)}`
      }))
    });
    if (!selectedId) {
  ...
  output_manager_default.log(
    `Route found in ${import_chalk107.default.bold(project.name)} ${import_chalk107.default.gray(inspectStamp())}`
  );
  if (showDiff) {
...
async function showRouteDiff(client, projectId, teamId, stagingRoute) {
  ...
  if (!productionRoute) {
    output_manager_default.print(
      `
  ${import_chalk107.default.bold(stagingRoute.name)} ${import_chalk107.default.green("(new)")}
`
    );
    output_manager_default.print(`  ${import_chalk107.default.gray(stagingRoute.id)}
`);
    output_manager_default.print(
      `  ${import_chalk107.default.green("This route does not exist in production yet.")}
`
    );
    output_manager_default.print(formatRouteDetails(stagingRoute));
    return 0;
...
function diffField(label, oldVal, newVal) {
  if (oldVal === newVal) {
    if (!newVal)
      return "";
    return `  ${import_chalk107.default.cyan(label)} ${newVal}`;
  }
  if (!oldVal && newVal) {
    return `${import_chalk107.default.green("+")} ${import_chalk107.default.cyan(label)} ${newVal}`;
  }
  if (oldVal && !newVal) {
    return `${import_chalk107.default.red("-")} ${import_chalk107.default.cyan(label)} ${import_chalk107.default.strikethrough(oldVal)}`;
  }
  return `${import_chalk107.default.yellow("~")} ${import_chalk107.default.cyan(label)} ${import_chalk107.default.red(oldVal)} \u2192 ${import_chalk107.default.green(newVal)}`;
}
function formatRouteDiff(staging, production) {
  ...
  if (!hasChanges) {
    lines.push(`  ${import_chalk107.default.bold(staging.name)}`);
    lines.push(`  ${import_chalk107.default.gray(staging.id)}`);
    lines.push("");
    lines.push(`  ${import_chalk107.default.gray("No staged changes for this route.")}`);
    lines.push("");
    lines.push(import_chalk107.default.bold("  Route Configuration"));
    return lines.join("\n") + "\n" + formatRouteDetails(staging);
  }
  const typeLabels = getRouteTypeLabel(staging);
  const syntaxLabel = getSrcSyntaxLabel(staging);
  lines.push(`  ${import_chalk107.default.bold(staging.name)} ${import_chalk107.default.yellow("(modified)")}`);
  lines.push(`  ${import_chalk107.default.gray(staging.id)}`);
  lines.push("");
  if (production.description !== staging.description) {
    if (!production.description && staging.description) {
      lines.push(
        `${import_chalk107.default.green("+")} ${import_chalk107.default.cyan("Description:")}  ${staging.description}`
      );
    } else if (production.description && !staging.description) {
      lines.push(
        `${import_chalk107.default.red("-")} ${import_chalk107.default.cyan("Description:")}  ${import_chalk107.default.strikethrough(production.description)}`
      );
    } else {
      lines.push(
        `${import_chalk107.default.yellow("~")} ${import_chalk107.default.cyan("Description:")}  ${import_chalk107.default.red(production.description)} \u2192 ${import_chalk107.default.green(staging.description)}`
      );
    }
    lines.push("");
  ...
  lines.push(
    diffField("Status:", prodStatusText, stagingStatusText) || `  ${import_chalk107.default.cyan("Status:")}      ${stagingStatusText}`
  );
  lines.push(`  ${import_chalk107.default.cyan("Type:")}        ${typeLabels}`);
  lines.push("");
  lines.push(import_chalk107.default.bold("  Route Configuration"));
  const srcLine = diffField("Source:", production.route.src, staging.route.src);
  lines.push(srcLine || `  ${import_chalk107.default.cyan("Source:")}      ${staging.route.src}`);
  lines.push(`  ${import_chalk107.default.cyan("Syntax:")}      ${syntaxLabel}`);
  ...
  if (destLine)
    ...
    lines.push(`  ${import_chalk107.default.cyan("Destination:")} ${staging.route.dest}`);
  ...
  if (statusLine)
    ...
    lines.push(`  ${import_chalk107.default.cyan("HTTP Status:")} ${staging.route.status}`);
  ...
  if (allHeaderKeys.size > 0) {
    lines.push("");
    lines.push(import_chalk107.default.bold("  Response Headers"));
    for (const key of allHeaderKeys) {
      const prodVal = prodHeaders[key];
      const stagingVal = stagingHeaders[key];
      if (prodVal === stagingVal) {
        lines.push(`  ${import_chalk107.default.cyan(key + ":")} ${stagingVal}`);
      } else if (!prodVal) {
        lines.push(
          `${import_chalk107.default.green("+")} ${import_chalk107.default.cyan(key + ":")} ${stagingVal}`
        );
      } else if (!stagingVal) {
        lines.push(
          `${import_chalk107.default.red("-")} ${import_chalk107.default.cyan(key + ":")} ${import_chalk107.default.strikethrough(prodVal)}`
        );
      } else {
        lines.push(
          `${import_chalk107.default.yellow("~")} ${import_chalk107.default.cyan(key + ":")} ${import_chalk107.default.red(prodVal)} \u2192 ${import_chalk107.default.green(stagingVal)}`
        );
      }
    }
  }
  ...
  if (prodTransforms.length > 0 || stagingTransforms.length > 0) {
    lines.push("");
    lines.push(import_chalk107.default.bold("  Transforms"));
    ...
    for (let i = 0; i < stagingTransforms.length; i++) {
      ...
      if (prodIdx === -1) {
        lines.push(
          `${import_chalk107.default.green("+")} ${formatTransform(stagingTransforms[i])}`
        );
      } else {
        ...
        if (prodArgs !== stagingArgs) {
          lines.push(
            `${import_chalk107.default.yellow("~")} ${formatTransform(stagingTransforms[i])} ${import_chalk107.default.gray(`(was: ${prodArgs})`)}`
          );
        } else {
    ...
    for (let i = 0; i < prodTransforms.length; i++) {
      ...
      if (!stagingKeys.includes(key)) {
        lines.push(
          `${import_chalk107.default.red("-")} ${import_chalk107.default.strikethrough(formatTransformPlain(prodTransforms[i]))}`
        );
      }
    }
  }
  ...
  if (prodHas.length > 0 || stagingHas.length > 0) {
    lines.push("");
    lines.push(import_chalk107.default.bold("  Has Conditions"));
  ...
  if (prodMissing.length > 0 || stagingMissing.length > 0) {
    lines.push("");
    lines.push(import_chalk107.default.bold("  Does Not Have Conditions"));
...
function diffConditions(lines, prodConditions, stagingConditions) {
  ...
  for (const cond of stagingConditions) {
    ...
    if (prodKeys.includes(key)) {
      ...
      lines.push(`${import_chalk107.default.green("+")} ${formatCondition(cond)}`);
    }
  }
  for (const cond of prodConditions) {
    const key = conditionKey(cond);
    if (!stagingKeys.includes(key)) {
      lines.push(`${import_chalk107.default.red("-")} ${formatCondition(cond)}`);
    }
  }
}
function formatRouteDetails(rule) {
  ...
  const typeLabels = getRouteTypeLabel(rule);
  const syntaxLabel = getSrcSyntaxLabel(rule);
  const statusText = rule.enabled === false ? import_chalk107.default.red("Disabled") : import_chalk107.default.green("Enabled");
  lines.push(`  ${import_chalk107.default.bold(rule.name)}`);
  lines.push(`  ${import_chalk107.default.gray(rule.id)}`);
  lines.push("");
  if (rule.description) {
    lines.push(`  ${rule.description}`);
    lines.push("");
  }
  lines.push(`  ${import_chalk107.default.cyan("Status:")}      ${statusText}`);
  if (rule.staged === true) {
    lines.push(
      `  ${import_chalk107.default.cyan("State:")}       ${import_chalk107.default.yellow("Staged (not yet published)")}`
    );
  } else if (rule.staged === false) {
    lines.push(`  ${import_chalk107.default.cyan("State:")}       ${import_chalk107.default.green("Published")}`);
  }
  lines.push(`  ${import_chalk107.default.cyan("Type:")}        ${typeLabels}`);
  lines.push("");
  lines.push(import_chalk107.default.bold("  Route Configuration"));
  lines.push(`  ${import_chalk107.default.cyan("Source:")}      ${rule.route.src}`);
  lines.push(`  ${import_chalk107.default.cyan("Syntax:")}      ${syntaxLabel}`);
  if (rule.route.dest) {
    lines.push(`  ${import_chalk107.default.cyan("Destination:")} ${rule.route.dest}`);
  }
  if (rule.route.status) {
    lines.push(`  ${import_chalk107.default.cyan("HTTP Status:")} ${rule.route.status}`);
  }
  ...
  if (responseHeaderSets.length > 0 || responseHeaderTransforms.length > 0) {
    ...
    for (const [key, value] of responseHeaderSets) {
      lines.push(`  ${import_chalk107.default.yellow("set")} ${import_chalk107.default.cyan(key)} = ${value}`);
    }
  ...
  if (requestHeaderTransforms.length > 0) {
    lines.push("");
    lines.push(import_chalk107.default.bold("  Request Headers"));
  ...
  if (requestQueryTransforms.length > 0) {
    lines.push("");
    lines.push(import_chalk107.default.bold("  Request Query"));
...
async function add9(client, argv) {
  const parsed = await parseSubcommandArgs(argv, addSubcommand9);
  if (typeof parsed === "number")
    return parsed;
  const link = await ensureProjectLink(client);
  if (typeof link === "number")
  ...
  try {
    ...
    output_manager_default.log(
      `${import_chalk108.default.cyan("Created")} route "${name}" ${import_chalk108.default.gray(addStamp())}`
    );
    output_manager_default.print(`
  ${import_chalk108.default.bold("Route:")} ${route.name}
`);
    output_manager_default.print(`  ${import_chalk108.default.gray("ID:")} ${route.id}
`);
    output_manager_default.print(`  ${import_chalk108.default.gray("Path:")} ${src}
`);
    if (finalDest) {
      if (isRedirect) {
        output_manager_default.print(
          `  ${import_chalk108.default.gray("Redirect:")} ${finalDest} (${finalStatus})
`
        );
      } else {
        output_manager_default.print(`  ${import_chalk108.default.gray("Rewrite:")} ${finalDest}
`);
      }
    } else if (finalStatus) {
      output_manager_default.print(`  ${import_chalk108.default.gray("Status:")} ${finalStatus}
`);
    }
    if (Object.keys(headers).length > 0) {
      output_manager_default.print(
        `  ${import_chalk108.default.gray("Headers:")} ${Object.keys(headers).length} header(s)
`
      );
    }
    if (transforms.length > 0) {
      output_manager_default.print(
        `  ${import_chalk108.default.gray("Transforms:")} ${transforms.length} transform(s)
`
      );
    }
    if (hasConditions.length > 0 || missingConditions.length > 0) {
      output_manager_default.print(
        `  ${import_chalk108.default.gray("Conditions:")} ${hasConditions.length} has, ${missingConditions.length} missing
`
      );
    }
    if (version.alias) {
      ...
      output_manager_default.print(
        `
  ${import_chalk108.default.bold("Test your changes:")} ${import_chalk108.default.cyan(`https://${version.alias}${testPath}`)}
`
      );
    }
    output_manager_default.print(`
  ${import_chalk108.default.bold("Staging version:")} ${version.id}
`);
  ...
  for (; ; ) {
    ...
    if (choice === "manual") {
      ...
      try {
        ...
        output_manager_default.log(
          `${import_chalk108.default.cyan("Created")} route "${route.name}" ${import_chalk108.default.gray(addStamp())}`
        );
        output_manager_default.print(`
  ${import_chalk108.default.bold("Route:")} ${route.name}
`);
...
async function main17(client) {
  ...
  switch (subcommand) {
    ...
    case "edit":
      ...
      return (await import("./chunks/edit-FNTDTSNB.js")).default(client, args);
    case "delete":
      if (needHelp) {
        telemetry2.trackCliFlagHelp("routes", subcommandOriginal);
      ...
      return (await import("./chunks/delete-R5E7M2HE.js")).default(client, args);
    case "enable":
      if (needHelp) {
        telemetry2.trackCliFlagHelp("routes", subcommandOriginal);
      ...
      telemetry2.trackCliSubcommandEnable(subcommandOriginal);
      return (await import("./chunks/enable-32W3N6KI.js")).default(client, args);
    case "disable":
      if (needHelp) {
        telemetry2.trackCliFlagHelp("routes", subcommandOriginal);
      ...
      telemetry2.trackCliSubcommandDisable(subcommandOriginal);
      return (await import("./chunks/disable-UMDIVQEI.js")).default(client, args);
    case "reorder":
      if (needHelp) {
        telemetry2.trackCliFlagHelp("routes", subcommandOriginal);
      ...
      return (await import("./chunks/reorder-HSZAJKBB.js")).default(client, args);
    case "export":
      if (needHelp) {
        telemetry2.trackCliFlagHelp("routes", subcommandOriginal);
      ...
      return (await import("./chunks/export-A75S2N6F.js")).default(client, args);
    case "publish":
      if (needHelp) {
        telemetry2.trackCliFlagHelp("routes", subcommandOriginal);
      ...
      return (await import("./chunks/publish-PB4E4HM4.js")).default(client, args);
    case "restore":
      if (needHelp) {
        telemetry2.trackCliFlagHelp("routes", subcommandOriginal);
      ...
      telemetry2.trackCliSubcommandRestore(subcommandOriginal);
      return (await import("./chunks/restore-Y4IVRAFY.js")).default(client, args);
    case "discard-staging":
      ...
      return (await import("./chunks/discard-R4N4UHES.js")).default(client, args);
    default:
...
// src/commands/skills/index.ts
var SKILLS_API = "https://skills.sh/api/search";
var FETCH_TIMEOUT_MS2 = 1e4;
var MIN_INSTALLS = 100;
var MAX_RESULTS = 8;
var MAX_FRAMEWORK_RESULTS = 4;
var MAX_DEP_QUERIES = 5;
...
async function searchSkills(query) {
  try {
    ...
    try {
      ...
      if (!res.ok) {
        output_manager_default.debug(`Skills API returned ${res.status} for query "${query}"`);
        return [];
      }
    ...
    output_manager_default.debug(`Skills search failed for "${query}": ${err}`);
    return [];
  }
}
...
async function readPackageDeps(cwd) {
  try {
    const raw = await readFile5(join5(cwd, "package.json"), "utf8");
...
function cleanDepName(dep) {
  return dep.replace(/^@/, "").replace(/\//g, "-");
}
async function isSkillInstalled(name, cwd) {
  const sanitized = name.toLowerCase().replace(/\s+/g, "-");
  const dirs = [
    join5(cwd, ".agents", "skills", sanitized),
    join5(homedir(), ".agents", "skills", sanitized)
  ];
...
async function skills(client) {
  ...
  const telemetry2 = new SkillsTelemetryClient({
    opts: {
      store: client.telemetryEventStore
    }
  });
  if (parsedArgs.flags["--help"]) {
    telemetry2.trackCliFlagHelp("skills");
    output_manager_default.print(help(skillsCommand, { columns: client.stderr.columns }));
    return 2;
  }
  telemetry2.trackCliFlagJson(parsedArgs.flags["--json"]);
  telemetry2.trackCliFlagYes(parsedArgs.flags["--yes"]);
  telemetry2.trackCliArgumentQuery(parsedArgs.args[1]);
  const formatResult = validateJsonOutput(parsedArgs.flags);
  if (!formatResult.valid) {
    output_manager_default.error(formatResult.error);
    return 1;
...
async function directSearch(client, query, asJson, cwd) {
  output_manager_default.spinner("Searching skills...");
  const results = await searchSkills(query);
  output_manager_default.stopSpinner();
  const filtered = results.filter((s) => s.installs >= MIN_INSTALLS).slice(0, MAX_RESULTS);
  const { exitCode: exitCode2 } = await displayResults(
    client,
    filtered,
    asJson,
    `Search: "${query}"`,
...
async function autoDetect(client, cwd, asJson, yes) {
  output_manager_default.spinner("Detecting project...");
  ...
  if (!framework && deps.length === 0) {
    ...
    output_manager_default.log(
      `Try searching directly: ${import_chalk109.default.cyan("vercel skills <query>")}`
    );
    return 0;
  }
  const detectedParts = [];
  if (framework)
    detectedParts.push(framework.name);
  if (language !== "unknown")
    detectedParts.push(language);
  if (deps.length > 0)
    detectedParts.push(deps.join(", "));
  output_manager_default.stopSpinner();
  output_manager_default.log(`Detected: ${import_chalk109.default.bold(detectedParts.join(" + "))}`);
  output_manager_default.spinner("Searching for relevant skills...");
  const queries = [];
  if (framework) {
    const slug = (framework.slug || framework.name).toLowerCase().replace(/-\d+$/, "");
    queries.push({ term: slug, tier: "framework" });
    const base = slug.replace(/(kit|js)$/, "");
    if (base && base !== slug) {
      queries.push({ term: base, tier: "framework" });
    }
    output_manager_default.debug(`Framework queries: ${queries.map((q) => q.term).join(", ")}`);
  }
  ...
  const frameworkSkills = /* @__PURE__ */ new Map();
  const depSkills = /* @__PURE__ */ new Map();
  ...
  const sortByInstalls = (a, b) => b.installs - a.installs;
  const topFramework = Array.from(frameworkSkills.values()).sort(sortByInstalls).slice(0, MAX_FRAMEWORK_RESULTS);
  for (const fw of topFramework) {
    depSkills.delete(fw.skillId);
  }
  const topDeps = Array.from(depSkills.values()).sort(sortByInstalls).slice(0, MAX_RESULTS - topFramework.length);
  ...
  if (exitCode2 !== 0 || asJson)
    return exitCode2;
  const installable = displayedResults.map((s, i) => ({ ...s, installed: installedChecks[i] })).filter((s) => !s.installed);
  if (installable.length === 0) {
    output_manager_default.log(import_chalk109.default.green("All recommended skills are already installed."));
    return 0;
  }
  let toInstall;
  if (yes) {
    ...
    const selected = await client.input.checkbox({
      ...
      choices: installable.map((s) => ({
        name: `${s.skillId} ${import_chalk109.default.gray(`(${s.source})`)}`,
        value: s,
        checked: true
      }))
    });
    if (!Array.isArray(selected) || selected.length === 0) {
      output_manager_default.log("No skills selected.");
      return 0;
    }
    toInstall = selected;
  }
...
`
  ...
  for (const [source, skillIds] of bySource) {
    ...
    output_manager_default.spinner(`Installing ${label} from ${source}...`);
    const args = ["skills", "add", source];
    for (const id of skillIds) {
      args.push("--skill", id);
    }
    args.push("-y");
    output_manager_default.debug(`> npx ${args.join(" ")}`);
    const code2 = await runCommand("npx", args);
    output_manager_default.stopSpinner();
    if (code2 !== 0) {
  ...
  if (failed.length > 0) {
    output_manager_default.error(`Failed to install: ${failed.join(", ")}`);
  }
  return 0;
}
async function displayResults(client, results, asJson, context, cwd) {
...
`
  ...
  const tableData = [
    ["Skill", "Installs", "Source", ""].map((h) => import_chalk109.default.bold(import_chalk109.default.cyan(h))),
    ...results.map((s, i) => [
      s.skillId,
      formatInstalls(s.installs),
      import_chalk109.default.gray(s.source),
      installedChecks[i] ? import_chalk109.default.green("installed") : ""
    ])
  ];
  output_manager_default.log(`
...
function runCommand(cmd2, args) {
  return new Promise((resolve7) => {
    ...
    child.on("close", (code2) => resolve7(code2 ?? 1));
...
function formatBranchMatcher(branchMatcher) {
  if (branchMatcher?.type === "equals") {
    ...
    return `${branchMatcher.pattern}${import_chalk110.default.dim("*")}`;
  } else if (branchMatcher?.type === "endsWith") {
    return `${import_chalk110.default.dim("*")}${branchMatcher.pattern}`;
  }
  return import_chalk110.default.dim("No branch configuration");
}
var TYPE_MAP = {
...
var BRANCH_TRACKING_MAP = {
  ...
  preview: (_, env) => env.slug === "preview" ? import_chalk110.default.dim("All unassigned git branches") : formatBranchMatcher(env.branchMatcher),
  development: () => import_chalk110.default.dim("Accessible via CLI")
};
...
`);
    ...
    output_manager_default.log(
      `${result.length} Environment${result.length === 1 ? "" : "s"} found under ${projectSlugLink} ${import_chalk110.default.gray(`[${elapsed2}]`)}`
    );
    const tablePrint = table(
      [
...
var COMMAND_CONFIG25 = {
  ls: getCommandAliases(listSubcommand13)
};
async function main18(client) {
  ...
  switch (subcommand) {
    ...
    default:
      output_manager_default.error(getInvalidSubcommand(COMMAND_CONFIG25));
      output_manager_default.print(help(targetCommand, { columns: client.stderr.columns }));
      return 2;
  }
}
...
`);
    ...
    const teamTable = table(
      [
        ["id", "Team name"].map((str) => (0, import_chalk111.gray)(str)),
...
Please select a team scope using ${getCommandName(
  ...
  output_manager_default.log(
    introMsg || `Inviting team members to ${import_chalk112.default.bold(currentTeam.name)}`
  );
  ...
  if (emails.length > 0) {
    for (const email3 of emails) {
      if (email.test(email3)) {
        ...
        output_manager_default.log(
          `${import_chalk112.default.cyan(chars_default.tick)} ${email3}${userInfo ? ` (${userInfo})` : ""} ${elapsed2()}`
        );
      } else {
        output_manager_default.log(`${import_chalk112.default.red(`\u2716 ${email3}`)} ${import_chalk112.default.gray("[invalid]")}`);
      }
    }
    return 0;
  }
  ...
  do {
    ...
    if (email2) {
      ...
      try {
        ...
        emails.push(email2);
        output_manager_default.log(`${import_chalk112.default.cyan(chars_default.tick)} ${sentEmailPrefix}${email2}`);
        if (hasError) {
          hasError = false;
          ...
          for (const email3 of emails) {
            output_manager_default.log(`${import_chalk112.default.cyan(chars_default.tick)} ${inviteUserPrefix}${email3}`);
          }
        }
      } catch (err) {
        output_manager_default.stopSpinner();
        ...
        hasError = true;
        for (const email3 of emails) {
          output_manager_default.log(`${import_chalk112.default.cyan(chars_default.tick)} ${sentEmailPrefix}${email3}`);
        }
      }
    }
  } while (email2 !== "");
...
var teamUrlPrefix = "Team URL".padEnd(14) + import_chalk113.default.gray("vercel.com/");
var teamNamePrefix = "Team Name".padEnd(14);
async function add10(client) {
  let slug;
  let team;
  let elapsed2;
  output_manager_default.log(
    `Pick a team identifier for its URL (e.g.: ${import_chalk113.default.cyan(
      "`vercel.com/acme`"
    )})`
  );
  do {
  ...
  output_manager_default.log(`${import_chalk113.default.cyan(`${chars_default.tick} `) + teamUrlPrefix + slug}
`);
  ...
  output_manager_default.log(`${import_chalk113.default.cyan(`${chars_default.tick} `) + teamNamePrefix + team.name}
`);
...
async function change(client, argv) {
  ...
  if (!desiredSlug) {
    const teamChoices = teams2.slice(0).sort((a, b) => {
      ...
      if (selected) {
        title3 += ` ${import_chalk114.default.bold("(current)")}`;
      }
      if (team.limited) {
        title3 += ` ${emoji("locked")}`;
      }
    ...
    let suffix = personalScopeSelected ? ` ${import_chalk114.default.bold("(current)")}` : "";
    if (user.limited) {
      suffix += ` ${emoji("locked")}`;
    }
  ...
  if (desiredSlug === user.username || desiredSlug === user.email) {
    ...
    output_manager_default.success(
      `Your account (${import_chalk114.default.bold(user.username)}) is now active!`
    );
    return 0;
  }
  ...
  if (!newTeam) {
    output_manager_default.error(
      `You do not have permission to access scope ${import_chalk114.default.bold(desiredSlug)}.`
    );
    return 1;
  }
  ...
  output_manager_default.success(
    `The team ${import_chalk114.default.bold(newTeam.name)} (${newTeam.slug}) is now active!`
  );
  return 0;
}
...
async function status2(client) {
  ...
  const status3 = enabled ? import_chalk115.default.green("Enabled") : import_chalk115.default.red("Disabled");
  output_manager_default.print("\n");
  output_manager_default.log(`${import_chalk115.default.bold("Telemetry status")}: ${status3}
`);
  const learnMoreMessage = `

Learn more: ${import_chalk115.default.cyan("https://vercel.com/docs/cli/about-telemetry")}`;
  if (enabled) {
...
async function telemetry(client) {
  ...
  switch (subcommand) {
    ...
    default: {
      ...
      output_manager_default.print(
        `${import_chalk116.default.red("Error")}: ${errorMessage}. See help instructions for usage:
`
      );
      output_manager_default.print(help(telemetryCommand, { columns: client.stderr.columns }));
      return 2;
...
function outputAggregated({ data, startTime }) {
  ...
  log(
    `Usage for ${import_chalk117.default.bold(data.contextName)} ${elapsed(Date.now() - startTime)}`
  );
  log("");
  const periodSuffix = data.usingDefaults ? " (current month)" : "";
  log(
    `${import_chalk117.default.gray("Period:")} ${data.fromDisplay} to ${data.toDisplay}${periodSuffix}`
  );
  log(`${import_chalk117.default.gray("Charges processed:")} ${data.chargeCount}`);
  log(`${import_chalk117.default.gray("Pricing unit:")} ${data.pricingUnit}`);
  log("");
  ...
  rows.push([
    import_chalk117.default.bold("Total"),
    import_chalk117.default.bold(
      formatQuantity(data.grandTotals.pricingQuantity, data.pricingUnit)
    ),
    import_chalk117.default.bold(formatCurrency(data.grandTotals.effectiveCost)),
    import_chalk117.default.bold(formatCurrency(data.grandTotals.billedCost))
  ]);
  const tablePrint = table(
    [headers.map((h) => import_chalk117.default.bold(import_chalk117.default.cyan(h))), ...rows],
...
`);
  log(
    `${import_chalk117.default.gray("Amount due:")} ${import_chalk117.default.bold(formatCurrency(data.grandTotals.billedCost))}`
  );
}
...
function outputBreakdown({
  ...
  log(
    `${periodLabel} Usage for ${import_chalk118.default.bold(data.contextName)} ${elapsed(Date.now() - startTime)}`
  );
  log("");
  const periodSuffix = data.usingDefaults ? " (current month)" : "";
  log(
    `${import_chalk118.default.gray("Period:")} ${data.fromDisplay} to ${data.toDisplay}${periodSuffix}`
  );
  log(`${import_chalk118.default.gray("Charges processed:")} ${data.chargeCount}`);
  log(`${import_chalk118.default.gray("Pricing unit:")} ${data.pricingUnit}`);
  log("");
  const sortedServices = [...data.services.entries()].sort(
    (a, b) => b[1].billedCost - a[1].billedCost
  );
  ...
  for (const periodKey of sortedPeriods) {
    ...
    log(
      `${import_chalk118.default.bold(import_chalk118.default.cyan(periodKey))} (Total: ${formatQuantity(periodData.totalPricingQuantity, data.pricingUnit)}, ${formatCurrency(periodData.totalBilledCost)})`
    );
    ...
    const tablePrint = table(
      [headers.map((h) => import_chalk118.default.bold(import_chalk118.default.gray(h))), ...rows],
      { hsep: 4, align: ["l", "r", "r"] }
    ).replace(/^/gm, "  ");
    print(`${tablePrint}
`);
...
async function usage(client) {
  ...
  const start = Date.now();
  if (!asJson) {
    spinner(`Fetching usage data for ${import_chalk119.default.bold(contextName)}`);
  }
...
async function ls7(client, argv) {
  ...
  const { contextName } = await getScope(client);
  const lsStamp = stamp_default();
  output_manager_default.spinner(`Fetching Webhooks under ${import_chalk120.default.bold(contextName)}`);
...
`);
    ...
    output_manager_default.log(
      `${(0, import_pluralize13.default)("Webhook", webhooks.length, true)} found under ${import_chalk120.default.bold(
        contextName
      )} ${import_chalk120.default.gray(lsStamp())}`
    );
...
function formatWebhooksTable(webhooks) {
  ...
  const rows = webhooks.map((webhook) => {
    ...
    return [webhook.id, webhook.url, eventsDisplay, import_chalk120.default.gray(age)];
  });
  return formatTable(
    ["ID", "URL", "Events", "Age"],
    ["l", "l", "l", "l"],
...
async function get3(client, argv) {
  ...
  const { contextName } = await getScope(client);
  output_manager_default.spinner(
    `Fetching Webhook ${webhookId} under ${import_chalk121.default.bold(contextName)}`
  );
  let webhook;
  try {
...
`);
    ...
    output_manager_default.log(
      `Webhook ${webhookId} found under ${import_chalk121.default.bold(contextName)} ${import_chalk121.default.gray(
        getStamp()
      )}`
    );
    output_manager_default.print("\n");
    output_manager_default.print(import_chalk121.default.bold("  General\n\n"));
    output_manager_default.print(`    ${import_chalk121.default.cyan("ID")}			${webhook.id}
`);
    output_manager_default.print(`    ${import_chalk121.default.cyan("URL")}			${webhook.url}
`);
    output_manager_default.print(
      `    ${import_chalk121.default.cyan("Created At")}		${formatDate(webhook.createdAt)}
`
    );
    output_manager_default.print(
      `    ${import_chalk121.default.cyan("Updated At")}		${formatDate(webhook.updatedAt)}
`
    );
    output_manager_default.print("\n");
    output_manager_default.print(import_chalk121.default.bold("  Events\n\n"));
...
`);
    ...
    if (webhook.projectIds && webhook.projectIds.length > 0) {
      output_manager_default.print("\n");
      output_manager_default.print(import_chalk121.default.bold("  Projects\n\n"));
...
async function create(client, argv) {
  ...
  if (!eventFlags || eventFlags.length === 0) {
    if (client.nonInteractive) {
      output_manager_default.error(
        `At least one event is required. Use ${import_chalk122.default.cyan("--event <event>")} to specify events.`
      );
      output_manager_default.log(
  ...
  output_manager_default.spinner(`Creating webhook under ${import_chalk122.default.bold(contextName)}`);
  try {
    ...
    output_manager_default.success(
      `Webhook created: ${import_chalk122.default.bold(webhook.id)} ${createStamp()}`
    );
    output_manager_default.print("\n");
    output_manager_default.print(import_chalk122.default.bold("  Webhook Details\n\n"));
    output_manager_default.print(`    ${import_chalk122.default.cyan("ID".padEnd(10))}${webhook.id}
`);
    output_manager_default.print(`    ${import_chalk122.default.cyan("URL".padEnd(10))}${webhook.url}
`);
    output_manager_default.print(
      `    ${import_chalk122.default.cyan("Events".padEnd(10))}${webhook.events.join(", ")}
`
    );
    if (webhook.projectIds && webhook.projectIds.length > 0) {
      output_manager_default.print(
        `    ${import_chalk122.default.cyan("Projects".padEnd(10))}${webhook.projectIds.join(", ")}
`
      );
    }
    output_manager_default.print("\n");
    output_manager_default.warn(
      `Save this secret - it will not be shown again: ${import_chalk122.default.bold(webhook.secret)}`
    );
    output_manager_default.print("\n");
    return 0;
  } catch (err) {
...
async function rm7(client, argv) {
  ...
  const removeStamp = stamp_default();
  output_manager_default.spinner(`Removing webhook under ${import_chalk123.default.bold(contextName)}`);
  try {
    await deleteWebhook(client, webhookId);
    output_manager_default.success(`Webhook ${import_chalk123.default.bold(webhookId)} removed ${removeStamp()}`);
    return 0;
  } catch (err) {
    if (isAPIError(err) && err.status === 404) {
      output_manager_default.error(`Webhook not found: ${webhookId}`);
...
async function main19(client) {
  ...
  switch (subcommand) {
    ...
    default:
      if (needHelp) {
        telemetry2.trackCliFlagHelp("webhooks", subcommandOriginal);
        return printHelp(listSubcommand16);
      }
      telemetry2.trackCliSubcommandList(subcommandOriginal);
      return ls7(client, args);
  }
}
...
export {
  ...
  inspect3 as inspect,
  install,
  main11 as integration,
  main12 as integrationResource,
  login,
  logout2 as logout,
  logs,
  main13 as mcp,
  metrics,
  main14 as microfrontends,
